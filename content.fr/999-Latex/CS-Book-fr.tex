...
\newcommand*{\afficheimagechapitre}[1]{
    \begin{tcolorbox}[halign=center,width=\paperwidth,boxrule=0mm,colback=white,colframe=white,notitle,left=0mm,right=0mm,top=0mm,bottom=0mm,left skip=0mm,beforeafter skip=0mm,
