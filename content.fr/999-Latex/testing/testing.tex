...
{\textcolor{RedViolet}{\Large Chapitre \ \thechapter \\ \huge \uppercase{#1} \\ \hspace*{-75pt} \includegraphics[width=\paperwidth]{../img/CS-page4-01.png}}
  } % label
{0pt} % sep
{
    \centering
...
{0pt} %before-step
{0mm} %after-step
\titlecontents{section}% define TOC style for parts
    [2cm]%left
...
\sffamily
\begin{testcolors}[rgb,HTML,cmyk,hsb,gray]
\testcolor{RedViolet}
\testcolor{CSRED}
\testcolor{CSREDD}
...
\chapter{Cinquième section}

\chapter{Sixième section}

\part{Troisième partie}

\chapter{Septième section}

\chapter{Huitième section}
