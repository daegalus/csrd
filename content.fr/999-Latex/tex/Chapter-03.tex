...
%            CHAPTER 3
%#######################################################################
    \startchapter{Comment jouer au Cypher System}{ch:chapter3}{RedViolet}
...
%     }
\chapterfirstletter{L}{RedViolet}es règles du Cypher System sont assez simples à la base, car toute la mécanique de jeu repose sur quelques concepts fondamentaux.
