...
%            CHAPTER 4
%#######################################################################
\chapter{Créer Votre Personnage}
\label{ch:chapter4}
...
\reversemarginpar{\textcolor{BlueViolet}{La Puissance peut être pensée comme Puissance/Santé car elle contrôle à quel point vous être fort et à quel niveau de chocs physiques vous pouvez supporter.}}
...
\subsection*{Célérité}
\marginpar{\textcolor{BlueViolet}{La Célérité peut être pensée comme de la Vitesse ou de l'Agilité car elle contrôle votre célérité et vos reflexes.}}
...
\marginpar{\textcolor{BlueViolet}{L'Intellect peut être pensée comme de l'intelligence ou de la Personnalité car elle contrôle à la fois l'intelligence et le charisme.}}
