...
\chapterfirstletter{L}{BlueViolet}e Type de personnage est le coeur de votre personnage. Son type vous aide à déterminer sa place dans le monde et les relations avec les autres dans la campagne. C'est le "nom" dans la phrase "Je suis un/e textit{nom+adjectif} qui textit{proposition}"
...
\begin{table*}[b]
    ...
    \begin{tabular}{ c p{18cm} }
        \multicolumn{2}{ l }{\Large \textcolor{BlueViolet}{Relation avec l'histoire personnelle d'un Guerrier}} \\
