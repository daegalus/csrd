...
Les préférences sont des groupes de capacités spéciales que la Meneuse et les joueurs peuvent utiliser pour modifier le type de personnage pour mieux l'affiner vers l'image qu'ils en ont ou pour qu'il soit mieux adapté au genre ou au cadre de campagne. Par exemple, si une joueuse veut créer un personnage voleur utilisant la magie, elle pourrait jouer une Adepte avec une préférence pour la furtivité. Dans un cadre de campagne de science fiction, un Guerrier pourrait avoir des connaissances en machinerie, donc le personnage pourrait avoir une préférence pour la technologie.
