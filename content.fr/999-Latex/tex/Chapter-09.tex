...
%            CHAPTER 9
%#######################################################################
\startchapter{Capacités}{ch:chapter9}{\getcolorpartone}
% \chapter{Capacités}
% \label{ch:chapter9}
...
% }
\chapterfirstletter{C}{\getcolorpartone}e chapitre présente un grand catalogue de plus d'un millier de capacités qu'un personnage peut obtenir par son type, ses préférences et son focus. Elles sont triées par ordre alphabétique.
...
\titleformat{name=\subsection,numberless}[runin]
    {\normalfont\scshape}
    {{\includegraphics[height=3mm]{img/CS-mini-logo.png}}\textbf{#1:}\ } % label
    {0pt}{}[]
...
\subsection*{A l'Aise à Bord}
\phantomsection\label{subsec:ab_ship_footing}
...
\subsection*{Absorber l'Esprit}
\phantomsection\label{subsec:ab_infuse_spirit}
...
\subsection*{Absorber l'énergie}
\phantomsection\label{subsec:ab_absorb_energy}
...
\subsection*{Absorber l'énergie cinétique}
\phantomsection\label{subsec:ab_absorb_kinetic_energy}
...
\subsection*{Absorber l'énergie pure}
\phantomsection\label{subsec:ab_absorb_pure_energy}
...
\subsection*{Absorption d'énergie cinétique améliorée}
\phantomsection\label{subsec:ab_improved_absorb_kinetic_energy}
...
\subsection*{Accélération temporelle}
\phantomsection\label{subsec:ab_temporal_acceleration}
...
\subsection*{Accélérer}
\phantomsection\label{subsec:ab_up_to_speed}
...
\subsection*{Activer les autres}
\phantomsection\label{subsec:ab_enable_others}
...
\subsection*{Activiste communautaire}
\phantomsection\label{subsec:ab_community_activist}
...
\phantomsection\label{subsec:ab_adaptation}
...
\subsection*{Adaptation à l'eau}
\phantomsection\label{subsec:ab_water_adaptation}

Vous pouvez respirer de l'eau aussi facilement que de l'air. Facilitateur. (Water Adaptation \textendash (196))

\subsection*{Adepte de la microgravité}
\phantomsection\label{subsec:ab_microgravity_adept}
...
\subsection*{Adepte des manœuvres}
\phantomsection\label{subsec:ab_maneuvering_adept}
...
\subsection*{Affichage Tête Haute}
\phantomsection\label{subsec:ab_heads_up_display}
...
\subsection*{Affinité machine}
\phantomsection\label{subsec:ab_machine_affinity}

Vous êtes entraîné aux tâches impliquant des machines électriques. Facilitateur. (Machine Affinity \textendash (159))

\subsection*{Affirmer votre privilège}
\phantomsection\label{subsec:ab_asserting_your_privilege}
...
\subsection*{Agent Provocateur}
\phantomsection\label{subsec:ab_agent_provocateur}
...
\subsection*{Agrandir}
\phantomsection\label{subsec:ab_enlarge}
...
\subsection*{Agrandissement Efrayant}
\phantomsection\label{subsec:ab_freakishly_large}
...
\subsection*{Agression}
\phantomsection\label{subsec:ab_agression}
...
\subsection*{Aide amicale}
\phantomsection\label{subsec:ab_friendly_help}
...
\subsection*{Aiguillon}
\phantomsection\label{subsec:ab_goad}
...
\subsection*{Ailes comme Arme}
\phantomsection\label{subsec:ab_wing_weapons}
...
\subsection*{Ailes de Feu}
\phantomsection\label{subsec:ab_wings_of_fire}
...
\subsection*{Ailes du Vide}
\phantomsection\label{subsec:ab_void_wings}
...
\subsection*{Aller au sol}
\phantomsection\label{subsec:ab_go_to_ground}
...
\subsection*{Allumage}
\phantomsection\label{subsec:ab_ignition}
...
\subsection*{Altération corporelle}
\phantomsection\label{subsec:ab_body_morph}
...
\subsection*{Amitié de groupe}
\phantomsection\label{subsec:ab_group_friendship}
...
\subsection*{Amplifier les sons}
\phantomsection\label{subsec:ab_amplify_sounds}
...
\subsection*{Amélioration de la machine}
\phantomsection\label{subsec:ab_machine_enhancement}
...
\subsection*{Amélioration du robot}
\phantomsection\label{subsec:ab_robot_improvement}

votre assistant artificiel grâce à la capacité Assistant Robot passe au niveau 4. Enabler. (Robot Improvement \textendash (179))

\subsection*{Améliorer la force}
\phantomsection\label{subsec:ab_enhance_strength}
...
\subsection*{Analyse d'animal}
\phantomsection\label{subsec:ab_animal_scrying}
...
\subsection*{Analyse en laboratoire}
\phantomsection\label{subsec:ab_lab_analysis}
...
\subsection*{Anecdote}
\phantomsection\label{subsec:ab_anecdote}
...
\subsection*{Annuler}
\phantomsection\label{subsec:ab_undo}
...
\subsection*{Annuler le danger}
\phantomsection\label{subsec:ab_negate_danger}
...
\subsection*{Annuler le son}
\phantomsection\label{subsec:ab_nullify_sound}
...
\phantomsection\label{subsec:ab_anticipation}
...
\subsection*{Anticipation de l'attaque}
\phantomsection\label{subsec:ab_anticipate_attack}
...
\subsection*{Apaiser l'esprit et le corps}
\phantomsection\label{subsec:ab_soothe_mind_and_body}
...
\subsection*{Apaiser la Bête Sauvage}
\phantomsection\label{subsec:ab_soothe_the_savage}
...
\subsection*{Aperçu de l'appareil}
\phantomsection\label{subsec:ab_device_insight}
...
\subsection*{Appel de Bête}
\phantomsection\label{subsec:ab_beast_call}
...
\subsection*{Appel à travers le temps}
\phantomsection\label{subsec:ab_call_through_time}
...
\subsection*{Appeler l'esprit d'un mort}
\phantomsection\label{subsec:ab_call_dead_spirit}
...
\subsection*{Appeler la tempête}
\phantomsection\label{subsec:ab_call_the_storm}
...
\subsection*{Appeler un esprit d'un autre monde}
\phantomsection\label{subsec:ab_call_otherworldly_spirit}
...
\subsection*{Appeller un essaim}
\phantomsection\label{subsec:ab_call_swarm}
...
\subsection*{Appliquer vos connaissances}
\phantomsection\label{subsec:ab_applying_your_knowledge}
...
\subsection*{Apprendre le chemin}
\phantomsection\label{subsec:ab_learning_the_path}
...
\subsection*{Appris des trucs}
\phantomsection\label{subsec:ab_learned_a_few_things}
...
\subsection*{Arme Electrique}
\phantomsection\label{subsec:ab_charge_weapon}
...
\subsection*{Arme de défense}
\phantomsection\label{subsec:ab_defending_weapon}
...
\subsection*{Arme enchantée}
\phantomsection\label{subsec:ab_enchanted_weapon}
...
\subsection*{Armement}
\phantomsection\label{subsec:ab_weaponization}
...
\subsection*{Armes intégrées}
\phantomsection\label{subsec:ab_built_in_weaponry}
...
\subsection*{Armure Corporelle}
\phantomsection\label{subsec:ab_fusion_armor}
...
\subsection*{Armure Renforcée par Champs de Force}
\phantomsection\label{subsec:ab_field_reinforced_armor}
...
\subsection*{Armure de Glace}
\phantomsection\label{subsec:ab_ice_armor}
...
\subsection*{Armure de glace résiliente}
\phantomsection\label{subsec:ab_resilient_ice_armor}
...
\subsection*{Armure de vent}
\phantomsection\label{subsec:ab_wind_armor}
...
\subsection*{Armure motorisée}
\phantomsection\label{subsec:ab_powered_armor}
...
\subsection*{Armure vivante}
\phantomsection\label{subsec:ab_living_armor}
...
\subsection*{Armure électrique}
\phantomsection\label{subsec:ab_electric_armor}
...
\subsection*{Artisan}
\phantomsection\label{subsec:ab_crafter}

Vous êtes entraîné à la fabrication de deux types d'objets. Facilitateur. (Crafter \textendash (122))

\subsection*{Artisan de Poisons}
\phantomsection\label{subsec:ab_poison_crafter}
...
\subsection*{Artisan expert}
\phantomsection\label{subsec:ab_expert_crafter}
...
\subsection*{Artisan naturel}
\phantomsection\label{subsec:ab_natural_crafter}
...
\subsection*{Artisanat des Rêves}
\phantomsection\label{subsec:ab_dreamcraft}
...
\subsection*{Artiste de la confiance}
\phantomsection\label{subsec:ab_confidence_artist}
...
\subsection*{As du Volant}
\phantomsection\label{subsec:ab_trick_driver}
...
\subsection*{Assaut Magique}
\phantomsection\label{subsec:ab_onslaught}
...
\subsection*{Assistance compétente}
\phantomsection\label{subsec:ab_able_assistance}
...
\subsection*{Assistant Robot}
\phantomsection\label{subsec:ab_robot_assistant}
...
\subsection*{Assumer le contrôle}
\phantomsection\label{subsec:ab_assume_control}
...
\subsection*{Astuces subtiles}
\phantomsection\label{subsec:ab_subtle_tricks}
...
\subsection*{Athlète}
\phantomsection\label{subsec:ab_athlete}

Vous êtes entraîné à porter, grimper, sauter et écraser. Facilitateur. (Athlete \textendash (111))

\subsection*{Attaque Etourdissante}
\phantomsection\label{subsec:ab_stun_attack}
...
\subsection*{Attaque Surprise Améliorée}
\phantomsection\label{subsec:ab_better_surprise_attack}
...
\subsection*{Attaque Tournoyante}
\phantomsection\label{subsec:ab_spin_attack}
...
\subsection*{Attaque acrobatique}
\phantomsection\label{subsec:ab_acrobatic_attack}
...
\subsection*{Attaque avec style}
\phantomsection\label{subsec:ab_attack_flourish}
...
\subsection*{Attaque aveuglante}
\phantomsection\label{subsec:ab_blinding_attack}
...
\subsection*{Attaque de Phase}
\phantomsection\label{subsec:ab_phased_attack}
...
\subsection*{Attaque de Phase Améliorée}
\phantomsection\label{subsec:ab_enhanced_phased_attack}
...
\subsection*{Attaque de désarmement}
\phantomsection\label{subsec:ab_disarming_attack}
...
\subsection*{Attaque en réponse}
\phantomsection\label{subsec:ab_answering_attack}
...
\subsection*{Attaque psychokinétique}
\phantomsection\label{subsec:ab_psychokinetic_attack}
...
\subsection*{Attaque rapide}
\phantomsection\label{subsec:ab_rapid_attack}
...
\subsection*{Attaque sautée}
\phantomsection\label{subsec:ab_jump_attack}
...
\subsection*{Attaque successive}
\phantomsection\label{subsec:ab_successive_attack}
...
\subsection*{Attaque surprise}
\phantomsection\label{subsec:ab_surprise_attack}
...
\subsection*{Attaque étourdissante}
\phantomsection\label{subsec:ab_dazing_attack}
...
\subsection*{Attaquer les yeux}
\phantomsection\label{subsec:ab_eye_gouge}
...
\subsection*{Attaquez et attaquez encore}
\phantomsection\label{subsec:ab_attack_and_attack_again}
...
\subsection*{Attitude de commandement}
\phantomsection\label{subsec:ab_demeanor_of_command}
...
\subsection*{Au diable les coupables}
\phantomsection\label{subsec:ab_damn_the_guilty}
...
\subsection*{Augmentation Cypher}
\phantomsection\label{subsec:ab_augment_cypher}
...
\subsection*{Augmentation de la portée}
\phantomsection\label{subsec:ab_range_increase}
...
\subsection*{Augmentation défensive}
\phantomsection\label{subsec:ab_defensive_augmentation}
...
\subsection*{Augmente les dommages}
\phantomsection\label{subsec:ab_damage_dealer}

Vous infligez 3 points de dégâts supplémentaires avec l'arme de votre choix. Facilitateur. (Damage Dealer \textendash (124))

\subsection*{Aura fétide}
\phantomsection\label{subsec:ab_foul_aura}
...
\subsection*{Aussi Rapide que l'Eclair}
\phantomsection\label{subsec:ab_flash_across_the_miles}
...
\subsection*{Autodocteur}
\phantomsection\label{subsec:ab_autodoctor}
...
\subsection*{Avantage d'Intellect Amélioré}
\phantomsection\label{subsec:ab_enhanced_intellect_edge}

Vous gagnez +1 à votre Avantage d'Intellect. Facilitateur. (Enhanced Intellect Edge \textendash (135))

\subsection*{Avantage de Célérité Amélioré}
\phantomsection\label{subsec:ab_enhanced_speed_edge}

Vous gagnez +1 à votre Avantage de Célérité. Facilitateur. (Enhanced Speed Edge \textendash (135))

\subsection*{Avantage de Puissance Amélioré}
\phantomsection\label{subsec:ab_enhanced_might_edge}

vous gagnez +1 à votre Avantage de Puissance. Facilitateur. (Enhanced Might Edge \textendash (135))

\subsection*{Avantage de Stat Amélioré}
\phantomsection\label{subsec:ab_improved_edge}

choisissez un de vos Avantage de statistique qui est de 0. Il passe à 1. Enabler. (Improved Edge \textendash (151))

\subsection*{Avantage par Désavantage}
\phantomsection\label{subsec:ab_advantage_to_disadvantage}
...
\subsection*{Avantages d'être grand}
\phantomsection\label{subsec:ab_advantages_of_being_big}
...
\subsection*{Avantages d'être petit}
\phantomsection\label{subsec:ab_advantages_of_being_small}
...
\subsection*{Avantages de la célébrité}
\phantomsection\label{subsec:ab_perks_of_stardom}
...
\subsection*{Ayez une Combinaison Spatiale, Vous Voyagerez}
\phantomsection\label{subsec:ab_have_spacesuit_will_travel}
...
\subsection*{Babel}
\phantomsection\label{subsec:ab_babel}
...
\subsection*{Bande de Desperados}
\phantomsection\label{subsec:ab_band_of_desperados}
...
\subsection*{Bande de suivants}
\phantomsection\label{subsec:ab_band_of_followers}
...
\subsection*{Barrière de champ de force}
\phantomsection\label{subsec:ab_force_field_barrier}
...
\subsection*{Barrière de conversion sonore}
\phantomsection\label{subsec:ab_sound_conversion_barrier}
...
\subsection*{Blessure de téléportation}
\phantomsection\label{subsec:ab_teleportive_wound}
...
\subsection*{Blocage rapide}
\phantomsection\label{subsec:ab_quick_block}
...
\subsection*{Bloquer}
\phantomsection\label{subsec:ab_block}
...
\subsection*{Bloquer pour un autre}
\phantomsection\label{subsec:ab_block_for_another}
...
\subsection*{Bon conseil}
\phantomsection\label{subsec:ab_good_advice}
...
\subsection*{Booster la fonction de cypher manifeste}
\phantomsection\label{subsec:ab_boost_manifest_cypher_function}
...
\subsection*{Booster un Cypher Manifeste}
\phantomsection\label{subsec:ab_boost_manifest_cypher}
...
\subsection*{Boucle temporelle}
\phantomsection\label{subsec:ab_time_loop}
...
\subsection*{Bouclier Explosif}
\phantomsection\label{subsec:ab_shield_burst}
...
\subsection*{Bouclier Magique}
\phantomsection\label{subsec:ab_magic_shield}

Vous gagnez +1 en Armure pendant une heure. Action à initier. (Magic Shield \textendash (159))

\subsection*{Bouclier de Champ de Force}
\phantomsection\label{subsec:ab_force_field_shield}
...
\subsection*{Bouclier de protection}
...
\subsection*{Bouclier enveloppant}
\phantomsection\label{subsec:ab_enveloping_shield}
...
\subsection*{Bouclier rebondissant}
\phantomsection\label{subsec:ab_bouncing_shield}
...
\subsection*{Bouclier énergisé}
\phantomsection\label{subsec:ab_energized_shield}
...
\subsection*{Bouquet d'évasion}
\phantomsection\label{subsec:ab_burst_of_escape}
...
\subsection*{Bricoleur}
\phantomsection\label{subsec:ab_tinker}
...
\subsection*{Bricoleur d'artefacts}
\phantomsection\label{subsec:ab_artifact_tinkerer}
...
\subsection*{Brise Esprit}
\phantomsection\label{subsec:ab_shatter_mind}
...
\subsection*{Briser}
\phantomsection\label{subsec:ab_shatter}
...
\subsection*{Briser la ligne}
\phantomsection\label{subsec:ab_break_the_line}
...
\subsection*{Briser les rangs}
\phantomsection\label{subsec:ab_break_the_ranks}
...
\subsection*{Briser leur esprit}
\phantomsection\label{subsec:ab_break_their_mind}
...
\subsection*{Briseur de Pierre}
\phantomsection\label{subsec:ab_stone_breaker}
...
\subsection*{Brouiller une Machine}
\phantomsection\label{subsec:ab_scramble_machine}
...
\subsection*{Bénédiction des Dieux}
\phantomsection\label{subsec:ab_blessing_of_the_gods}
...
\subsection*{Calme}
\phantomsection\label{subsec:ab_calm}
...
\subsection*{Calmer un Etranger}
\phantomsection\label{subsec:ab_calm_stranger}
...
\subsection*{Camouflage sauvage}
\phantomsection\label{subsec:ab_wild_camouflage}
...
\subsection*{Capteur}
\phantomsection\label{subsec:ab_sensor}
...
\subsection*{Capteur amélioré}
\phantomsection\label{subsec:ab_improved_sensor}
...
\subsection*{Captiver avec Eclat}
\phantomsection\label{subsec:ab_captivate_with_starshine}
...
\subsection*{Captiver ou Inspirer}
\phantomsection\label{subsec:ab_captivate_or_inspire}
...
\subsection*{Carnivore sous la Lune}
\phantomsection\label{subsec:ab_moon_shape}
...
\subsection*{Casseur}
\phantomsection\label{subsec:ab_breaker}
...
\subsection*{Cauchemar}
\phantomsection\label{subsec:ab_nightmare}
...
\subsection*{Cavalier}
\phantomsection\label{subsec:ab_rider}
...
\subsection*{Centre d'attention}
\phantomsection\label{subsec:ab_center_of_attention}
...
\subsection*{Chair de Pierre}
\phantomsection\label{subsec:ab_flesh_of_stone}

Vous avez +1 à l'Armure si vous ne portez pas d'armure physique. Facilitateur. (Flesh of Stone \textendash (141))

\subsection*{Chair de guerre}
\phantomsection\label{subsec:ab_war_flesh}
...
\subsection*{Chambre des rêves}
\phantomsection\label{subsec:ab_chamber_of_dreams}
...
\subsection*{Champ de destruction}
\phantomsection\label{subsec:ab_field_of_destruction}
...
\phantomsection\label{subsec:ab_force_field}
...
\subsection*{Champ de gravité}
\phantomsection\label{subsec:ab_field_of_gravity}
...
\subsection*{Champ de renforcement}
\phantomsection\label{subsec:ab_reinforcing_field}
...
\subsection*{Champ de résonance}
\phantomsection\label{subsec:ab_resonance_field}
...
\subsection*{Champ défensif}
\phantomsection\label{subsec:ab_defensive_field}
...
\phantomsection\label{subsec:ab_magnetic_field}
...
\subsection*{Champ réactif}
\phantomsection\label{subsec:ab_reactive_field}
...
\subsection*{Chance Etonnante}
\phantomsection\label{subsec:ab_uncanny_luck}
...
\subsection*{Chanceux-Malchanceux}
\phantomsection\label{subsec:ab_gambler}
...
\subsection*{Changement contrôlé Supérieur}
\phantomsection\label{subsec:ab_greater_controlled_change}
...
\subsection*{Changement d'Identité}
\phantomsection\label{subsec:ab_spin_identity}
...
\subsection*{Changement de Visage}
\phantomsection\label{subsec:ab_face_morph}
...
\subsection*{Changements Rapides}
\phantomsection\label{subsec:ab_quick_switch}
...
\subsection*{Changer le paradigme}
\phantomsection\label{subsec:ab_change_the_paradygm}
...
\subsection*{Charge}
\phantomsection\label{subsec:ab_charge}
...
\subsection*{Charge Drainante}
\phantomsection\label{subsec:ab_drain_charge}
...
\subsection*{Charge en Horde}
\phantomsection\label{subsec:ab_charging_horde}
...
\subsection*{Chariot à vent}
\phantomsection\label{subsec:ab_wind_chariot}
...
\subsection*{Charisme naturel}
\phantomsection\label{subsec:ab_natural_charisma}
...
\subsection*{Charmer une Machine}
\phantomsection\label{subsec:ab_charm_machine}
...
\subsection*{Chasse aux machines}
\phantomsection\label{subsec:ab_machine_hunting}
...
\phantomsection\label{subsec:ab_driver}
...
\subsection*{Chauffeur expert}
\phantomsection\label{subsec:ab_expert_driver}
...
\subsection*{Chercheur expérimenté}
\phantomsection\label{subsec:ab_experienced_finder}
...
\subsection*{Choc}
\phantomsection\label{subsec:ab_bash}
...
\subsection*{Choc Electrique}
\phantomsection\label{subsec:ab_shock}
...
\subsection*{Chute contrôlée}
\phantomsection\label{subsec:ab_controlled_fall}
...
\subsection*{Chute en toute sécurité}
\phantomsection\label{subsec:ab_safe_fall}

Vous réduisez les dégâts d'une chute de 5 points. Facilitateur. (Safe Fall \textendash (179))

\subsection*{Cible difficile}
\phantomsection\label{subsec:ab_hard_target}
...
\subsection*{Claque}
\phantomsection\label{subsec:ab_swipe}
...
\subsection*{Client Fuyant}
\phantomsection\label{subsec:ab_slippery_customer}
...
\subsection*{Clignotement défensif}
\phantomsection\label{subsec:ab_defensive_blinking}
...
\subsection*{Cogneur Entraîné}
\phantomsection\label{subsec:ab_trained_basher}
...
\subsection*{Cogneur Spécialisé}
\phantomsection\label{subsec:ab_specialized_basher}
...
\subsection*{Collecte d'informations}
\phantomsection\label{subsec:ab_information_gathering}
...
\subsection*{Colossal}
\phantomsection\label{subsec:ab_colossal}
...
\subsection*{Combat spatial}
\phantomsection\label{subsec:ab_space_fighting}
...
\subsection*{Combats de Horde}
\phantomsection\label{subsec:ab_horde_fighting}
...
\subsection*{Combattant Hors-la-loi}
\phantomsection\label{subsec:ab_dirty_fighter}
...
\subsection*{Combattant aquatique}
\phantomsection\label{subsec:ab_aquatic_combattant}
...
\subsection*{Combattant de Robot}
\phantomsection\label{subsec:ab_robot_fighter}
...
\subsection*{Combattant mobile}
\phantomsection\label{subsec:ab_mobile_fighter}
...
\subsection*{Combattant sans armure}
\phantomsection\label{subsec:ab_unarmored_fighter}
...
\phantomsection\label{subsec:ab_command}
...
\subsection*{Commandement avancé}
\phantomsection\label{subsec:ab_advanced_command}
...
\subsection*{Commander aux bêtes}
\phantomsection\label{subsec:ab_command_beast}
...
\subsection*{Commander le Métal}
\phantomsection\label{subsec:ab_command_metal}
...
\subsection*{Commander un Esprit}
\phantomsection\label{subsec:ab_command_spirit}
...
\subsection*{Commander une Machine}
\phantomsection\label{subsec:ab_command_machine}
...
\subsection*{Comme McGyver}
\phantomsection\label{subsec:ab_jury_rig}
...
\subsection*{Comme l'éclair}
\phantomsection\label{subsec:ab_bolt_rider}
...
\subsection*{Comme le dos de votre main}
\phantomsection\label{subsec:ab_like_the_back_of_your_hand}
...
\subsection*{Comme le prédit la prophétie}
\phantomsection\label{subsec:ab_as_foretold_in_prophecy}
...
\subsection*{Comme s'il n'y a qu'une seule créature}
\phantomsection\label{subsec:ab_as_if_one_creature}
...
\subsection*{Comment les autres pensent}
\phantomsection\label{subsec:ab_how_others_think}
...
\phantomsection\label{subsec:ab_communication}
...
\subsection*{Compagnon Arbre}
\phantomsection\label{subsec:ab_tree_companion}
...
\subsection*{Compagnon Machine Amélioré}
\phantomsection\label{subsec:ab_improved_machine_companion}
...
\subsection*{Compagnon amélioré}
\phantomsection\label{subsec:ab_improved_companion}
...
\subsection*{Compagnon explorateur}
\phantomsection\label{subsec:ab_fellow_explorer}
...
\subsection*{Compagnon machine}
\phantomsection\label{subsec:ab_machine_companion}
...
\subsection*{Compagnon volant}
\phantomsection\label{subsec:ab_flying_companion}
...
\subsection*{Compression dimensionnelle}
\phantomsection\label{subsec:ab_dimensional_squeeze}
...
\phantomsection\label{subsec:ab_understanding}
...
\subsection*{Compétence avec les attaques}
\phantomsection\label{subsec:ab_skill_with_attacks}
...
\subsection*{Compétence d'arme en Prêt}
\phantomsection\label{subsec:ab_flex_weapon_skill}
...
\subsection*{Compétence d'expert}
\phantomsection\label{subsec:ab_expert_skill}
...
\subsection*{Compétence efficace}
\phantomsection\label{subsec:ab_effective_skill}
...
\subsection*{Compétence en Attaque Supérieure}
...
\subsection*{Compétence en Défense Supérieure}
\phantomsection\label{subsec:ab_greater_skill_with_defense}
...
\subsection*{Compétence en défense}
\phantomsection\label{subsec:ab_skill_with_defense}
...
\subsection*{Compétence supplémentaire}
\phantomsection\label{subsec:ab_extra_skill}
...
\subsection*{Compétences accrues}
\phantomsection\label{subsec:ab_heightened_skills}
...
\subsection*{Compétences d'assassin}
\phantomsection\label{subsec:ab_assassin_skills}

Vous êtes entraîné aux tâches de furtivité et de déguisement. Facilitateur. (Assassin Skills \textendash (110))

\subsection*{Compétences d'enquête}
\phantomsection\label{subsec:ab_investigative_skills}
...
\subsection*{Compétences d'interaction}
\phantomsection\label{subsec:ab_interaction_skills}
...
\subsection*{Compétences de voyage}
\phantomsection\label{subsec:ab_travel_skills}
...
\subsection*{Compétences en Connaissances}
\phantomsection\label{subsec:ab_knowledge_skills}
...
\subsection*{Compétences en Gage}
\phantomsection\label{subsec:ab_flex_skill}
...
\subsection*{Compétences furtives}
\phantomsection\label{subsec:ab_stealth_skills}
...
\subsection*{Compétences multiples}
\phantomsection\label{subsec:ab_multiple_skills}
...
\subsection*{Compétences physiques}
\phantomsection\label{subsec:ab_physical_skills}
...
\subsection*{Compétences sous Vide Spatial}
\phantomsection\label{subsec:ab_vacuum_skilled}
...
\phantomsection\label{subsec:ab_tech_skills}
...
\phantomsection\label{subsec:ab_concussion}
...
\subsection*{Conduite Dangereuse}
\phantomsection\label{subsec:ab_driving_on_the_edge}
...
\subsection*{Confondre l'ennemi}
\phantomsection\label{subsec:ab_confuse_enemy}
...
\phantomsection\label{subsec:ab_conjuration}
...
\subsection*{Connaissance de la communauté}
\phantomsection\label{subsec:ab_community_knowledge}
...
\subsection*{Connaissance de la loi}
\phantomsection\label{subsec:ab_knowledge_of_the_law}
...
\subsection*{Connaissance des monstres}
\phantomsection\label{subsec:ab_monster_lore}
...
\subsection*{Connaissance des ruines}
\phantomsection\label{subsec:ab_ruin_lore}
...
\subsection*{Connaissance divine}
\phantomsection\label{subsec:ab_divine_knowledge}
...
\subsection*{Connaissance du bestiaire}
\phantomsection\label{subsec:ab_bestiary_knowledge}
...
\subsection*{Connaissances en Prêt}
\phantomsection\label{subsec:ab_flex_lore}
...
\subsection*{Connaissances en milieu sauvage}
\phantomsection\label{subsec:ab_wilderness_lore}
...
\subsection*{Connaissez leurs défauts}
\phantomsection\label{subsec:ab_know_their_faults}
...
\subsection*{Connecté}
\phantomsection\label{subsec:ab_connected}
...
\phantomsection\label{subsec:ab_awareness}
...
\subsection*{Conscience totale}
\phantomsection\label{subsec:ab_total_awareness}
...
\subsection*{Conseils d'un ami}
\phantomsection\label{subsec:ab_advice_from_a_friend}
...
\subsection*{Considération approfondie}
\phantomsection\label{subsec:ab_deep_consideration}
...
\subsection*{Constructeur de fortifications}
\phantomsection\label{subsec:ab_fortification_builder}
...
\subsection*{Constructeur de robots}
\phantomsection\label{subsec:ab_robot_builder}
...
\subsection*{Contacts avec la pègre}
\phantomsection\label{subsec:ab_underworld_contacts}
...
\subsection*{Continuez le combat}
\phantomsection\label{subsec:ab_fight_on}
...
\subsection*{Contorsionniste}
\phantomsection\label{subsec:ab_contortionist}
...
\subsection*{Contourner la barrière}
\phantomsection\label{subsec:ab_bypass_barrier}
...
\subsection*{Contre-Danger}
\phantomsection\label{subsec:ab_counter_danger}
...
\phantomsection\label{subsec:ab_countermeasures}
...
\subsection*{Contrôle de Machine}
\phantomsection\label{subsec:ab_control_machine}
...
\subsection*{Contrôle de l'Essaim}
\phantomsection\label{subsec:ab_control_swarm}
...
\subsection*{Contrôle de la météo}
\phantomsection\label{subsec:ab_control_weather}
...
\subsection*{Contrôle des foules}
\phantomsection\label{subsec:ab_crowd_control}
...
\subsection*{Contrôle du Changement de Forme}
\phantomsection\label{subsec:ab_controlled_change}
...
\phantomsection\label{subsec:ab_robot_control}
...
\subsection*{Contrôle mental}
\phantomsection\label{subsec:ab_mind_control}
...
\subsection*{Contrôle parfait}
\phantomsection\label{subsec:ab_perfect_control}
...
\subsection*{Contrôler le sauvage}
\phantomsection\label{subsec:ab_control_the_savage}
...
\subsection*{Contrôler le terrain}
\phantomsection\label{subsec:ab_control_the_field}
...
\subsection*{Coordination Main-Oeil}
\phantomsection\label{subsec:ab_hand_to_eye}
...
\subsection*{Copain}
\phantomsection\label{subsec:ab_buddy_system}
...
\subsection*{Copie Améliorée}
\phantomsection\label{subsec:ab_improved_copying}
...
\subsection*{Copie multiple}
\phantomsection\label{subsec:ab_multiple_copying}
...
\subsection*{Copie étonnante}
\phantomsection\label{subsec:ab_amazing_copying}
...
\subsection*{Coquille de matière noire}
\phantomsection\label{subsec:ab_dark_matter_shell}
...
\subsection*{Corps amélioré}
\phantomsection\label{subsec:ab_enhanced_body}
...
\subsection*{Corps de Cristal}
\phantomsection\label{subsec:ab_crystalline_body}
...
\subsection*{Corps de Golem}
\phantomsection\label{subsec:ab_golem_body}
...
\subsection*{Corps en bois}
\phantomsection\label{subsec:ab_wooden_body}
...
\subsection*{Couleurs Eblouissantes}
\phantomsection\label{subsec:ab_dazzling_sunburst}
...
\subsection*{Coup brutal}
\phantomsection\label{subsec:ab_brute_strike}
...
\subsection*{Coup final}
\phantomsection\label{subsec:ab_finishing_blow}
...
\subsection*{Coup écrasant}
\phantomsection\label{subsec:ab_crushing_blow}
...
\subsection*{Coupe Précise}
\phantomsection\label{subsec:ab_precise_cut}

Vous infligez 1 point de dégâts supplémentaire avec des armes légères. Facilitateur. (Precise Cut \textendash (171))

\subsection*{Courage du noble}
\phantomsection\label{subsec:ab_nobles_courage}
...
\subsection*{Course d'obstacles}
\phantomsection\label{subsec:ab_obstacle_running}
...
\subsection*{Court et Attrape}
\phantomsection\label{subsec:ab_sprint_and_grab}
...
\subsection*{Cri fracassant}
\phantomsection\label{subsec:ab_shattering_shout}
...
\subsection*{Création de Glace}
\phantomsection\label{subsec:ab_ice_creation}
...
\subsection*{Créature magique liée}
\phantomsection\label{subsec:ab_bound_magic_creature}
...
\subsection*{Créer}
\phantomsection\label{subsec:ab_create}
...
\subsection*{Créer de l'eau}
\phantomsection\label{subsec:ab_create_water}
...
\subsection*{Créer un poison mortel}
\phantomsection\label{subsec:ab_create_deadly_poison}
...
\subsection*{Cube de flammes}
\phantomsection\label{subsec:ab_fire_bloom}
...
\subsection*{Curieux}
\phantomsection\label{subsec:ab_curious}
...
\subsection*{Cyphers recyclés}
\phantomsection\label{subsec:ab_recycled_cyphers}
...
\subsection*{Célérité améliorée}
\phantomsection\label{subsec:ab_enhanced_speed}

Vous gagnez 3 points dans votre Réserve de Célérité. Facilitateur. (Enhanced Speed \textendash (135))

\subsection*{Célérité améliorée supérieure}
\phantomsection\label{subsec:ab_greater_enhanced_speed}
...
\subsection*{Dans ma Main}
\phantomsection\label{subsec:ab_impetus}
...
\subsection*{Datajack}
\phantomsection\label{subsec:ab_datajack}
...
\subsection*{De Déchet à Objet}
\phantomsection\label{subsec:ab_junkmonger}
...
\subsection*{Demande d'une faveur}
\phantomsection\label{subsec:ab_call_in_favor}
...
\subsection*{Depuis les Ombres}
\phantomsection\label{subsec:ab_from_the_shadows}
...
\subsection*{Des choix difficiles}
\phantomsection\label{subsec:ab_hard_choices}
...
\subsection*{Destiné à la grandeur}
\phantomsection\label{subsec:ab_destined_for_greatness}
...
\phantomsection\label{subsec:ab_destroyer}
...
\subsection*{Deux Armes Légères}
\phantomsection\label{subsec:ab_dual_light_wield}
...
\subsection*{Deux Armes Moyennes}
\phantomsection\label{subsec:ab_dual_medium_wield}
...
\subsection*{Deux choses à la fois}
\phantomsection\label{subsec:ab_two_things_at_once}
...
\subsection*{Devenez défensif}
\phantomsection\label{subsec:ab_go_defensive}
...
\subsection*{Diagramme de combat}
\phantomsection\label{subsec:ab_cognizant_offense}
...
\phantomsection\label{subsec:ab_diamagnetism}
...
\subsection*{Dieu du jeu}
\phantomsection\label{subsec:ab_gaming_god}
...
\subsection*{Difficile à distraire}
\phantomsection\label{subsec:ab_hard_to_distract}

vous êtes entraîné aux tâches de défense intellectuelle. Facilitateur. (Hard to Distract \textendash (148))

\subsection*{Difficile à toucher}
\phantomsection\label{subsec:ab_hard_to_hit}

vous êtes entraîné aux tâches de défense rapide. Facilitateur. (Hard to Hit \textendash (148))

\subsection*{Difficile à tuer}
\phantomsection\label{subsec:ab_hard_to_kill}
...
\subsection*{Difficile à voir}
\phantomsection\label{subsec:ab_hard_to_see}
...
\subsection*{Dire les Choses}
\phantomsection\label{subsec:ab_telling}
...
\subsection*{Disciple expert}
\phantomsection\label{subsec:ab_expert_follower}
...
\subsection*{Discipline de vigilance}
...
\subsection*{Dislocation temporelle}
\phantomsection\label{subsec:ab_temporal_dislocation}
...
\subsection*{Disparaître}
\phantomsection\label{subsec:ab_vanish}
...
\phantomsection\label{subsec:ab_distortion}
...
\subsection*{Distraction verbale}
\phantomsection\label{subsec:ab_verbal_misdirection}
...
\subsection*{Divisez votre esprit}
\phantomsection\label{subsec:ab_divide_your_mind}
...
\subsection*{Doppelganger Temporel}
\phantomsection\label{subsec:ab_time_doppelganger}
...
\subsection*{Double Distraction}
\phantomsection\label{subsec:ab_dual_distraction}
...
\subsection*{Double défense}
\phantomsection\label{subsec:ab_dual_defense}
...
\subsection*{Double frappe}
\phantomsection\label{subsec:ab_double_strike}
...
\subsection*{Double protection}
\phantomsection\label{subsec:ab_dual_wards}
...
\subsection*{Drain de Créature}
\phantomsection\label{subsec:ab_drain_creature}
...
\subsection*{Drain de Machine}
\phantomsection\label{subsec:ab_drain_machine}
...
\subsection*{Drain de Puissance}
\phantomsection\label{subsec:ab_drain_power/}
...
\subsection*{Drain à distance}
\phantomsection\label{subsec:ab_drain_at_a_distance}
...
\subsection*{Draîner la vie}
\phantomsection\label{subsec:ab_unraveling_consumption}
...
\subsection*{Duel à mort}
\phantomsection\label{subsec:ab_duel_to_the_death}
...
\phantomsection\label{subsec:ab_duplicate}
...
\subsection*{Duplicata illusoire}
\phantomsection\label{subsec:ab_illusory_duplicate}
...
\subsection*{Duplicata résilient}
\phantomsection\label{subsec:ab_resilient_duplicate}

augmente la santé de tout doublon que vous créez (comme avec Duplicata) par 5. Enabler. (Resilient Duplicate \textendash (176))

\subsection*{Duplication Supérieure}
\phantomsection\label{subsec:ab_superior_duplicate}
...
\subsection*{Dur comme du Bois}
\phantomsection\label{subsec:ab_tough_as_nails}
...
\subsection*{Dynamiser un objet}
\phantomsection\label{subsec:ab_energize_object}
...
\subsection*{Débat}
\phantomsection\label{subsec:ab_debate}
...
\phantomsection\label{subsec:ab_decipher}
...
\subsection*{Déchirer L'Existence}
\phantomsection\label{subsec:ab_shred_existence}
...
\subsection*{Découpe}
\phantomsection\label{subsec:ab_slice}
...
\subsection*{Déduire des pensées}
\phantomsection\label{subsec:ab_infer_thoughts}
...
\subsection*{Défendre les innocents}
\phantomsection\label{subsec:ab_defend_the_innocent}
...
\subsection*{Défendre tous les innocents}
\phantomsection\label{subsec:ab_defend_all_the_innocent}
...
\subsection*{Défense avec Arme}
\phantomsection\label{subsec:ab_weapon_defense}
...
\subsection*{Défense contre les robots}
\phantomsection\label{subsec:ab_defense_against_robots}
...
\subsection*{Défense intérieure}
\phantomsection\label{subsec:ab_inner_defense}
...
\subsection*{Défense subconsciente}
\phantomsection\label{subsec:ab_subconscious_defense}
...
\subsection*{Défenseur dévoué}
\phantomsection\label{subsec:ab_devoted_defender}
...
\subsection*{Défenseur expérimenté}
\phantomsection\label{subsec:ab_experienced_defender}

lorsque vous portez une armure, vous gagnez +1 en armure. Facilitateur. (Experienced Defender \textendash (136))

\subsection*{Défi de combat}
\phantomsection\label{subsec:ab_combat_challenge}
...
\subsection*{Défi final}
\phantomsection\label{subsec:ab_final_defiance}
...
\subsection*{Définir le bas}
\phantomsection\label{subsec:ab_define_down}
...
\subsection*{Défoncer}
\phantomsection\label{subsec:ab_wreck}
...
\phantomsection\label{subsec:ab_disguise}
...
\subsection*{Déguisement illusoire}
\phantomsection\label{subsec:ab_illusory_disguise}
...
\subsection*{Déguiser un autre}
\phantomsection\label{subsec:ab_disguise_other}
...
\subsection*{Dégâts mortels}
\phantomsection\label{subsec:ab_lethal_damage}
...
\subsection*{Déjouer Intelligemment}
\phantomsection\label{subsec:ab_outwit}
...
\subsection*{Déjouer le Danger}
\phantomsection\label{subsec:ab_foil_danger}
...
\subsection*{Démonstration Impressionnante}
\phantomsection\label{subsec:ab_impressive_display}
...
\subsection*{Démotiver}
\phantomsection\label{subsec:ab_disincentivize}
...
\subsection*{Déplacer des montagnes}
\phantomsection\label{subsec:ab_move_mountains}
...
\subsection*{Déplacer le métal}
\phantomsection\label{subsec:ab_move_metal}
...
\subsection*{Désactiver les mécanismes}
\phantomsection\label{subsec:ab_deactivate_mechanisms}
...
\subsection*{Désamorcer la situation}
\phantomsection\label{subsec:ab_defuse_situation}
...
\subsection*{Désignation}
\phantomsection\label{subsec:ab_designation}
...
\subsection*{Désignation Améliorée}
\phantomsection\label{subsec:ab_improved_designation}
...
\subsection*{Désignation supérieure}
\phantomsection\label{subsec:ab_greater_designation}
...
\subsection*{Détecter la vie}
\phantomsection\label{subsec:ab_detect_life}
...
\subsection*{Détective}
\phantomsection\label{subsec:ab_sleuth}
...
\subsection*{Détermination croissante}
\phantomsection\label{subsec:ab_increasing_determination}
...
\subsection*{Détonation biomorphique}
\phantomsection\label{subsec:ab_biomorphic_detonation}
...
\subsection*{Détonation de phase}
\phantomsection\label{subsec:ab_phase_detonation}
...
\subsection*{Détournement}
\phantomsection\label{subsec:ab_misdirect}
...
\subsection*{Détourner les attaques}
\phantomsection\label{subsec:ab_divert_attacks}
...
\subsection*{Détruire le métal}
\phantomsection\label{subsec:ab_destroy_metal}
...
\subsection*{Dévier les attaques}
\phantomsection\label{subsec:ab_deflect_attacks}
...
\phantomsection\label{subsec:ab_echolocation}
...
\subsection*{Eclairs de Puissance}
\phantomsection\label{subsec:ab_bolts_of_power}
...
\subsection*{Eclairé}
\phantomsection\label{subsec:ab_enlightened}

Vous êtes entraîné à toute tâche de perception impliquant la vue. Facilitateur. (Enlightened \textendash (136))

\subsection*{Effacer les souvenirs}
\phantomsection\label{subsec:ab_erase_memories}
...
\subsection*{Effets accrus}
\phantomsection\label{subsec:ab_increased_effects}
...
\subsection*{Efficacité de la machine}
\phantomsection\label{subsec:ab_machine_efficiency}
...
\subsection*{Effort coordonné}
\phantomsection\label{subsec:ab_coordinated_effort}
...
\subsection*{Effort incroyable}
\phantomsection\label{subsec:ab_amazing_effort}
...
\subsection*{Elaborer une stratégie}
\phantomsection\label{subsec:ab_strategize}
...
\subsection*{Eloignez-vous}
\phantomsection\label{subsec:ab_get_away}
...
\subsection*{Embrassez la nuit}
\phantomsection\label{subsec:ab_embrace_the_night}
...
\subsection*{Embrouiller}
\phantomsection\label{subsec:ab_fast_talk}
...
\subsection*{Embrouiller les Mémoires personnelles}
\phantomsection\label{subsec:ab_cloud_personal_memories}
...
\subsection*{Embuscade}
\phantomsection\label{subsec:ab_ambusher}
...
\subsection*{En Danger}
\phantomsection\label{subsec:ab_in_harm's_way}
...
\subsection*{En dehors de la réalité}
\phantomsection\label{subsec:ab_outside_reality}
...
\subsection*{En un Clin d'oeil}
\phantomsection\label{subsec:ab_blink_of_an_eye}

Vous vous déplacez jusqu'à 1 000 pieds (300 m) en un tour. Action. (Blink of an Eye \textendash (115))

\subsection*{Encore et encore}
...
\phantomsection\label{subsec:ab_encouragement}
...
\subsection*{Encouragement de la Nature}
\phantomsection\label{subsec:ab_wilderness_encouragement}
...
\phantomsection\label{subsec:ab_endurance}
...
\subsection*{Endurance du joueur}
\phantomsection\label{subsec:ab_gamer's_fortitude}
...
\subsection*{Energiser la créature}
\phantomsection\label{subsec:ab_energize_creature}
...
\subsection*{Energiser la foule}
\phantomsection\label{subsec:ab_energize_crowd}
...
\subsection*{Enorme}
\phantomsection\label{subsec:ab_huge}
...
\subsection*{Enquêter}
\phantomsection\label{subsec:ab_investigate}
...
\subsection*{Enquêteur}
\phantomsection\label{subsec:ab_investigator}
...
\subsection*{Enseigner une astuce}
\phantomsection\label{subsec:ab_teach_trick}
...
\subsection*{Ensemble de détection}
\phantomsection\label{subsec:ab_sensing_package}
...
\phantomsection\label{subsec:ab_entourage}
...
\subsection*{Entraînement au bouclier}
\phantomsection\label{subsec:ab_shield_training}
...
\subsection*{Entraînement aux tâches}
\phantomsection\label{subsec:ab_task_training}
...
\subsection*{Entraînement de guilde}
\phantomsection\label{subsec:ab_guild_training}
...
\subsection*{Entraînement magique}
\phantomsection\label{subsec:ab_magical_training}
...
\subsection*{Entraîné sans armure}
\phantomsection\label{subsec:ab_trained_without_armor}
...
\subsection*{Entretenir l'amitié}
\phantomsection\label{subsec:ab_work_the_friendship}
...
\phantomsection\label{subsec:ab_enthrall}
...
\subsection*{Epéiste entraîné}
\phantomsection\label{subsec:ab_trained_slayer}

vous êtes entraîné à l'utilisation des épées. Facilitateur. (Trained Slayer \textendash (193))

\subsection*{Equation prédictive}
\phantomsection\label{subsec:ab_predictive_equation}
...
\phantomsection\label{subsec:ab_balance}

Vous êtes entraîné à l'équilibre. Facilitateur. (Balance \textendash (112))

\subsection*{Eruption d'insectes}
\phantomsection\label{subsec:ab_insect_eruption}
...
\subsection*{Esprit Agile}
\phantomsection\label{subsec:ab_agile_wit}
...
\subsection*{Esprit Complice}
\phantomsection\label{subsec:ab_spirit_accomplice}
...
\subsection*{Esprit Protecteur}
\phantomsection\label{subsec:ab_wraith_cloak}
...
\subsection*{Esprit de Puissance}
\phantomsection\label{subsec:ab_mind_for_might}
...
\subsection*{Esprit de commandement amélioré}
\phantomsection\label{subsec:ab_improved_command_spirit}
...
\subsection*{Esprit de leader}
\phantomsection\label{subsec:ab_mind_of_a_leader}
...
\subsection*{Esprit fermé}
\phantomsection\label{subsec:ab_closed_mind}
...
\subsection*{Esprit ouvert}
\phantomsection\label{subsec:ab_open_mind}
...
\subsection*{Esprit parle moi d'ici}
\phantomsection\label{subsec:ab_reading_the_room}
...
\subsection*{Esprit perspicace}
\phantomsection\label{subsec:ab_discerning_mind}
...
\subsection*{Esprit polyvalent}
\phantomsection\label{subsec:ab_versatile_mind}
...
\subsection*{Esquive}
\phantomsection\label{subsec:ab_evasion}
...
\subsection*{Esquive et résistance}
\phantomsection\label{subsec:ab_dodge_and_resist}
...
\subsection*{Esquiver et répondre}
\phantomsection\label{subsec:ab_dodge_and_respond}
...
\subsection*{Essaim mortel}
\phantomsection\label{subsec:ab_deadly_swarm}
...
\subsection*{Est-ce que tu sais qui je suis?}
\phantomsection\label{subsec:ab_do_you_know_who_i_am?}
...
\subsection*{Estoc}
\phantomsection\label{subsec:ab_thrust}
...
\subsection*{Etude rapide}
\phantomsection\label{subsec:ab_quick_study}
...
\phantomsection\label{subsec:ab_evanesce}
...
\subsection*{Evasion}
\phantomsection\label{subsec:ab_escape}
...
\subsection*{Évasion illusoire}
\phantomsection\label{subsec:ab_illusory_evasion}
...
\subsection*{Evitement}
\phantomsection\label{subsec:ab_flight_not_fight}
...
\subsection*{Evitement par microgravité}
\phantomsection\label{subsec:ab_microgravity_avoidance}
...
\subsection*{Evolution du robot}
\phantomsection\label{subsec:ab_robot_evolution}
...
\subsection*{Exil}
\phantomsection\label{subsec:ab_exile}
...
\subsection*{Explique l'Ineffable}
\phantomsection\label{subsec:ab_explains_the_ineffable}
...
\subsection*{Exploiter l'Avantage}
\phantomsection\label{subsec:ab_exploit_advantage}
...
\subsection*{Explorateur Confirmé}
\phantomsection\label{subsec:ab_superb_explorer}
...
\subsection*{Explorateur de la Nature}
\phantomsection\label{subsec:ab_wilderness_explorer}
...
\subsection*{Explorateur des ténèbres}
\phantomsection\label{subsec:ab_dark_explorer}
...
\subsection*{Explosion Divine}
\phantomsection\label{subsec:ab_overawe}
...
\subsection*{Explosion commotionnelle}
\phantomsection\label{subsec:ab_concussive_blast}
...
\subsection*{Explosion de Force}
\phantomsection\label{subsec:ab_force_blast}
...
\subsection*{Explosion de froid}
\phantomsection\label{subsec:ab_cold_burst}
...
\subsection*{Expérience d'exploration}
\phantomsection\label{subsec:ab_exploratory_experience}
...
\subsection*{Expérimenté en armure}
\phantomsection\label{subsec:ab_experienced_in_armor}
...
\subsection*{Extraire du hasard}
\phantomsection\label{subsec:ab_wrest_from_chance}
...
\subsection*{Fabricant d'armes}
\phantomsection\label{subsec:ab_weapon_crafter}
...
\subsection*{Facilité Inspirante}
\phantomsection\label{subsec:ab_inspiring_ease}
...
\subsection*{Faire Corps avec la Nature}
...
\subsection*{Faisceau de Tonnerre}
\phantomsection\label{subsec:ab_thunder_beam}
...
\subsection*{Faites confiance à la chance}
\phantomsection\label{subsec:ab_trust_to_luck}
...
\subsection*{Faites face aux vicissitudes}
\phantomsection\label{subsec:ab_weather_the_vicissitudes}
...
\subsection*{Familiarisez-vous}
\phantomsection\label{subsec:ab_familiarize}
...
\subsection*{Fantôme}
\phantomsection\label{subsec:ab_ghost}
...
\subsection*{Feinte}
\phantomsection\label{subsec:ab_feint}
...
\subsection*{Feu et Glace}
\phantomsection\label{subsec:ab_fire_and_ice}
...
\subsection*{Feuillage agrippant}
\phantomsection\label{subsec:ab_grasping_foliage}
...
\subsection*{Fièvre sanguinolente}
\phantomsection\label{subsec:ab_blood_fever}
...
\subsection*{Flash}
\phantomsection\label{subsec:ab_flash}
...
\subsection*{Floraison réparatrice}
\phantomsection\label{subsec:ab_restorative_bloom}
...
\subsection*{Flotte de robots}
\phantomsection\label{subsec:ab_robot_fleet}
...
\subsection*{Fléau des Monstres}
\phantomsection\label{subsec:ab_monster_bane}
...
\subsection*{Fléau des Monstres Amélioré}
\phantomsection\label{subsec:ab_improved_monster_bane}
...
\subsection*{Fléau des Monstres Géants}
\phantomsection\label{subsec:ab_heroic_monster_bane}
...
\subsection*{Force avec laquelle il faut compter}
\phantomsection\label{subsec:ab_force_to_reckon_with}
...
\subsection*{Force enchevêtrante}
\phantomsection\label{subsec:ab_entangling_force}
...
\subsection*{Force et Précision}
\phantomsection\label{subsec:ab_force_and_accuracy}
...
\subsection*{Force à distance}
\phantomsection\label{subsec:ab_force_at_distance}
...
\subsection*{Formation magique}
\phantomsection\label{subsec:ab_magic_training}
...
\subsection*{Forme animale}
\phantomsection\label{subsec:ab_animal_shape}
...
\subsection*{Forme animale plus grande}
\phantomsection\label{subsec:ab_bigger_animal_shape}
...
\subsection*{Forme de bête}
\phantomsection\label{subsec:ab_beast_form}
...
\subsection*{Forme de bête Supérieure}
\phantomsection\label{subsec:ab_greater_beast_form}
...
\subsection*{Forme de bête améliorée}
\phantomsection\label{subsec:ab_enhanced_beast_form}
...
\subsection*{Forme de bête plus grande}
\phantomsection\label{subsec:ab_bigger_beast_form}
...
\subsection*{Forêt Terrifiante}
\phantomsection\label{subsec:ab_dreadwood}
...
\subsection*{Frappe Explosive}
\phantomsection\label{subsec:ab_power_crash}
...
\subsection*{Frappe Renversante}
\phantomsection\label{subsec:ab_power_strike}
...
\subsection*{Frappe d'Assassin}
\phantomsection\label{subsec:ab_assassin_strike}
...
\subsection*{Frappe de Force}
\phantomsection\label{subsec:ab_force_bash}
...
\subsection*{Frappe de matière noire}
\phantomsection\label{subsec:ab_dark_matter_strike}
...
\subsection*{Frappe débilitante}
\phantomsection\label{subsec:ab_debilitating_strike}
...
\subsection*{Frappe désarmante}
\phantomsection\label{subsec:ab_disarming_strike}
...
\subsection*{Frappe mortelle}
\phantomsection\label{subsec:ab_deadly_strike}
...
\subsection*{Frappe nocturne}
\phantomsection\label{subsec:ab_nightstrike}
...
\subsection*{Frappe rapide}
\phantomsection\label{subsec:ab_quick_strike}
...
\subsection*{Frénésie}
\phantomsection\label{subsec:ab_frenzy}
...
\subsection*{Frénésie supérieure}
\phantomsection\label{subsec:ab_greater_frenzy}
...
\phantomsection\label{subsec:ab_resonant_frequency}
...
\subsection*{Fuir}
\phantomsection\label{subsec:ab_flee}
...
\subsection*{Fureur}
\phantomsection\label{subsec:ab_fury}
...
\subsection*{Fureur du berger}
\phantomsection\label{subsec:ab_shepherd's_fury}
...
\subsection*{Fusionne avec les Ténèbres}
\phantomsection\label{subsec:ab_embraced_by_darkness}
...
\subsection*{Fustiger}
\phantomsection\label{subsec:ab_castigate}
...
\subsection*{Gagner un compagnon inhabituel}
\phantomsection\label{subsec:ab_gain_unusual_companion}
...
\subsection*{Gantelets d'hiver}
\phantomsection\label{subsec:ab_winter_gauntlets}
...
\subsection*{Gargantuesque}
\phantomsection\label{subsec:ab_gargantuan}
...
\subsection*{Gestion de bataille}
\phantomsection\label{subsec:ab_battle_management}
...
\subsection*{Glissant}
\phantomsection\label{subsec:ab_slippery}

Vous êtes entraîné pour échapper à tout type de lien ou d'emprise. Facilitateur. (Slippery \textendash (183))

\subsection*{Graine de Tempête}
\phantomsection\label{subsec:ab_storm_seed}
...
\subsection*{Graines de fureur}
\phantomsection\label{subsec:ab_seeds_of_fury}
...
\subsection*{Grand Pas}
\phantomsection\label{subsec:ab_far_step}
...
\subsection*{Grand arbre}
\phantomsection\label{subsec:ab_great_tree}
...
\subsection*{Grande Déception}
\phantomsection\label{subsec:ab_grand_deception}
...
\subsection*{Gravité Coupante}
\phantomsection\label{subsec:ab_gravity_cleave}
...
\subsection*{Gravité Coupante Améliorée}
\phantomsection\label{subsec:ab_improved_gravity_cleave}
...
\subsection*{Grondement subsonique}
\phantomsection\label{subsec:ab_subsonic_rumble}
...
\subsection*{Gros Mensonge}
\phantomsection\label{subsec:ab_tall_tale}
...
\subsection*{Guerrier Capable}
\phantomsection\label{subsec:ab_capable_warrior}

Vos attaques infligent 1 point de dégâts supplémentaire. Facilitateur. (Capable Warrior \textendash (118))

\subsection*{Gueule de Dragon}
\phantomsection\label{subsec:ab_dragon's_maw}
...
\subsection*{Guide des eaux profondes}
...
\subsection*{Guérison biomorphique}
\phantomsection\label{subsec:ab_biomorphic_healing}
...
\subsection*{Guérison du Golem}
\phantomsection\label{subsec:ab_golem_healing}
...
\subsection*{Générer un champ de force}
\phantomsection\label{subsec:ab_generate_force_field}
...
\subsection*{Habiletés motrices}
\phantomsection\label{subsec:ab_movement_skills}

Vous êtes entraîné à l'escalade et au saut. Facilitateur. (Movement Skills \textendash (164))

\subsection*{Habiter le cristal}
\phantomsection\label{subsec:ab_inhabit_crystal}
...
\subsection*{Hacker}
\phantomsection\label{subsec:ab_hacker}
...
\subsection*{Hackez l'impossible}
\phantomsection\label{subsec:ab_hack_the_impossible}
...
\subsection*{Hors de danger}
\phantomsection\label{subsec:ab_out_of_harm's_way}
...
\phantomsection\label{subsec:ab_hemorrhage}
...
\subsection*{Ignorer l'Affliction}
\phantomsection\label{subsec:ab_ignore_affliction}
...
\subsection*{Ignorez la Douleur}
\phantomsection\label{subsec:ab_ignore_the_pain}

vous ignorez l'état Handicapé et traitez l'état Handicapé comme Diminué. Facilitateur. (Ignore the Pain \textendash (150))

\subsection*{Illusion grandiose}
\phantomsection\label{subsec:ab_grandiose_illusion}
...
\subsection*{Illusion majeure}
\phantomsection\label{subsec:ab_major_illusion}
...
\subsection*{Illusion mineure}
\phantomsection\label{subsec:ab_minor_illusion}
...
\subsection*{Illusion permanente}
\phantomsection\label{subsec:ab_permanent_illusion}
...
\subsection*{Image Miroir}
\phantomsection\label{subsec:ab_illusory_selves}

Lorsque vous êtes sur le point d'être touché par une attaque, vous vous téléportez à une distance immédiate, laissant derrière vous une copie illusoire de vous-même qui sera frappée par cette attaque à votre place. Cela détruit l'illusion mais vous laisse indemne par l'attaque. Si l'attaque affecte une zone et que la téléportation ne peut pas vous faire sortir de cette zone, l'attaque vous affecte quand même normalement. Facilitateur. (Illusory Selves \textendash (150))

\subsection*{Image terrifiante}
\phantomsection\label{subsec:ab_terrifying_image}
...
\subsection*{Immobile}
\phantomsection\label{subsec:ab_immovable}
...
\subsection*{Improviser}
\phantomsection\label{subsec:ab_improvise}
...
\subsection*{Inamovible}
\phantomsection\label{subsec:ab_unmovable}
...
\subsection*{Incroyable exploit scientifique}
\phantomsection\label{subsec:ab_incredible_feat_of_science}
...
\subsection*{Incroyable récupération}
\phantomsection\label{subsec:ab_incredible_recovery}
...
\subsection*{Infiltrateur}
\phantomsection\label{subsec:ab_infiltrator}

Vous êtes entraîné aux interactions impliquant des mensonges ou des supercheries. Facilitateur. (Infiltrator \textendash (153))

\subsection*{Infiltrateur Confirmé}
\phantomsection\label{subsec:ab_superb_infiltrator}
...
\subsection*{Influence d'Essaim}
\phantomsection\label{subsec:ab_influence_swarm}
...
\subsection*{Informateur}
\phantomsection\label{subsec:ab_informer}
...
\subsection*{Information sur une Créature}
\phantomsection\label{subsec:ab_creature_insight}
...
\subsection*{Innovateur}
\phantomsection\label{subsec:ab_innovator}
...
\subsection*{Insaisissable}
\phantomsection\label{subsec:ab_elusive}
...
\phantomsection\label{subsec:ab_inspiration}
...
\subsection*{Inspiration tardive}
\phantomsection\label{subsec:ab_late_inspiration}
...
\subsection*{Inspire des actions coordonnées}
\phantomsection\label{subsec:ab_inspire_coordinated_actions}
...
\subsection*{Inspire l'Agression}
\phantomsection\label{subsec:ab_inspire_aggression}
...
\subsection*{Inspirer l'action}
\phantomsection\label{subsec:ab_inspire_action}
...
\subsection*{Inspirez les innocents}
\phantomsection\label{subsec:ab_inspire_the_innocent}
...
\subsection*{Instinct de Danger}
\phantomsection\label{subsec:ab_danger_instinct}
...
\subsection*{Instinct de Magie Sauvage}
\phantomsection\label{subsec:ab_wild_insight}
...
\subsection*{Intellect Amélioré Supérieur}
\phantomsection\label{subsec:ab_greater_enhanced_intellect}

vous gagnez 6 points dans votre réserve d'Intellect. Facilitateur. (Greater Enhanced Intellect \textendash (146))

\subsection*{Intellect amélioré}
\phantomsection\label{subsec:ab_enhanced_intellect}

vous gagnez 3 points dans votre réserve d'Intellect. Facilitateur. (Enhanced Intellect \textendash (135))

\subsection*{Interaction intense}
\phantomsection\label{subsec:ab_intense_interaction}
...
\phantomsection\label{subsec:ab_interface}
...
\subsection*{Interface Machine}
\phantomsection\label{subsec:ab_machine_interface}
...
\subsection*{Interface distante}
\phantomsection\label{subsec:ab_distant_interface}
...
\subsection*{Interface intelligente}
\phantomsection\label{subsec:ab_intelligent_interface}
...
\subsection*{Interlocuteur qualifié}
\phantomsection\label{subsec:ab_trained_interlocutor}
...
\subsection*{Interrogation de l'âme}
\phantomsection\label{subsec:ab_soul_interrogation}
...
\subsection*{Interrogez les esprits}
\phantomsection\label{subsec:ab_question_the_spirits}
...
\phantomsection\label{subsec:ab_interruption}
...
\subsection*{Intervention divine}
\phantomsection\label{subsec:ab_divine_intervention}
...
\subsection*{Intouchable}
\phantomsection\label{subsec:ab_untouchable}
...
\subsection*{Intouchable en mouvement}
\phantomsection\label{subsec:ab_untouchable_while_moving}
...
\phantomsection\label{subsec:ab_inventor}
...
\subsection*{Invisibilité}
\phantomsection\label{subsec:ab_invisibility}
...
\subsection*{Invisibilité Multiple}
\phantomsection\label{subsec:ab_multi_vanish}
...
\subsection*{Invisibilité de Phase}
\phantomsection\label{subsec:ab_invisible_phasing}
...
\subsection*{Invoquer un démon}
\phantomsection\label{subsec:ab_summon_demon}
...
\subsection*{Invoquer une araignée géante}
\phantomsection\label{subsec:ab_summon_giant_spider}
...
\subsection*{Irréprochable}
\phantomsection\label{subsec:ab_blameless}
...
\subsection*{Jeux d'esprit}
\phantomsection\label{subsec:ab_mind_games}
...
\subsection*{Jouer devant la foule}
\phantomsection\label{subsec:ab_play_to_the_crowd}
...
\subsection*{Joueur}
\phantomsection\label{subsec:ab_gamer}
...
\phantomsection\label{subsec:ab_juggernaut}
...
\subsection*{Juste un peu fou}
\phantomsection\label{subsec:ab_just_a_bit_mad}
...
\phantomsection\label{subsec:ab_knock_out}
...
\subsection*{La chance du voleur}
\phantomsection\label{subsec:ab_thief's_luck}
...
\subsection*{La connaissance, c'est le pouvoir}
\phantomsection\label{subsec:ab_knowledge_is_power}
...
\subsection*{La mémoire devient une action}
\phantomsection\label{subsec:ab_memory_becomes_action}
...
\subsection*{La nature est de votre côté}
\phantomsection\label{subsec:ab_the_wild_is_on_your_side}
...
\subsection*{Lame de Feu}
\phantomsection\label{subsec:ab_flameblade}
...
\subsection*{Lancement de Cypher}
\phantomsection\label{subsec:ab_cypher_casting}
...
\subsection*{Lancement de flammes}
\phantomsection\label{subsec:ab_hurl_flame}
...
\subsection*{Lancer}
\phantomsection\label{subsec:ab_throw}
...
\subsection*{Lancer Illusion}
\phantomsection\label{subsec:ab_cast_illusion}
...
\subsection*{Lancer Objet en Fer}
\phantomsection\label{subsec:ab_iron_punch}
...
\subsection*{Lancer rapide}
\phantomsection\label{subsec:ab_quick_throw}
...
\subsection*{Lancer un bouclier de force}
\phantomsection\label{subsec:ab_throw_force_shield}
...
\subsection*{Lancer une arme enchantée}
\phantomsection\label{subsec:ab_throw_enchanted_weapon}
...
\subsection*{Lanceur spécialisé}
\phantomsection\label{subsec:ab_specialized_throwing}
...
\subsection*{Lavage de cerveau}
\phantomsection\label{subsec:ab_brainwashing}
...
\subsection*{Le pied marin}
\phantomsection\label{subsec:ab_sea_legs}
...
\subsection*{Le rêve devient réalité}
\phantomsection\label{subsec:ab_dream_becomes_reality}
...
\subsection*{Lecture mentale}
\phantomsection\label{subsec:ab_mind_reading}
...
\subsection*{Lentille Cristalline}
\phantomsection\label{subsec:ab_crystal_lens}
...
\subsection*{Leçons de jeu}
\phantomsection\label{subsec:ab_game_lessons}
...
\subsection*{Leçons de vie}
\phantomsection\label{subsec:ab_life_lessons}
...
\subsection*{Liaison machine}
\phantomsection\label{subsec:ab_machine_bond}
...
\subsection*{Libre de se déplacer}
\phantomsection\label{subsec:ab_free_to_move}
...
\subsection*{Libération d'énergie}
...
\subsection*{Libération explosive}
\phantomsection\label{subsec:ab_explosive_release}
...
\subsection*{Licence poétique}
\phantomsection\label{subsec:ab_poetic_license}
...
\subsection*{Lien d'Objet Amélioré}
\phantomsection\label{subsec:ab_improved_object_bond}
...
\subsection*{Lien d'objet}
\phantomsection\label{subsec:ab_object_bond}
...
\subsection*{Lien mental}
\phantomsection\label{subsec:ab_mental_link}
...
\subsection*{Lier les sens}
\phantomsection\label{subsec:ab_link_senses}
...
\subsection*{Lire les signes}
\phantomsection\label{subsec:ab_read_the_signs}
...
\subsection*{Lourd}
\phantomsection\label{subsec:ab_weighty}
...
\subsection*{Lueur automatique}
\phantomsection\label{subsec:ab_automatic_glow}
...
\subsection*{Lumière brûlante}
\phantomsection\label{subsec:ab_burning_light}
...
\subsection*{Lumière coupante}
\phantomsection\label{subsec:ab_cutting_light}
...
\subsection*{Lumière du soleil}
\phantomsection\label{subsec:ab_sunlight}
...
\subsection*{Lumière plus Forte}
\phantomsection\label{subsec:ab_harder_light}
...
\subsection*{Lumière sculptée améliorée}
\phantomsection\label{subsec:ab_improved_sculpt_light}
...
\subsection*{Lumière temporaire}
\phantomsection\label{subsec:ab_temporary_light}
...
\subsection*{Lumière vivante}
\phantomsection\label{subsec:ab_living_light}
...
\subsection*{Légèreté}
\phantomsection\label{subsec:ab_levity}
...
\subsection*{Machine aveugle}
\phantomsection\label{subsec:ab_blind_machine}
...
\subsection*{Magie Prosaïque}
\phantomsection\label{subsec:ab_hedge_magic}
...
\subsection*{Magie Sauvage plus rapide}
\phantomsection\label{subsec:ab_faster_wild_magic}
...
\subsection*{Main Guérisseuse}
\phantomsection\label{subsec:ab_healing_touch}
...
\subsection*{Main Guérisseuse Supérieure}
\phantomsection\label{subsec:ab_greater_healing_touch}
...
\subsection*{Main ardente du destin}
\phantomsection\label{subsec:ab_fiery_hand_of_doom}
...
\subsection*{Maintenez le cap}
\phantomsection\label{subsec:ab_stay_the_course}
...
\subsection*{Manteau d'opportunité}
\phantomsection\label{subsec:ab_cloak_of_opportunity}
...
\subsection*{Manteau de flammes}
\phantomsection\label{subsec:ab_shroud_of_flame}
...
\subsection*{Manteau de matière noire}
\phantomsection\label{subsec:ab_dark_matter_shroud}
...
\subsection*{Marche impossible}
\phantomsection\label{subsec:ab_impossible_walk}
...
\subsection*{Marin}
\phantomsection\label{subsec:ab_sailor}
...
\subsection*{Masque}
\phantomsection\label{subsec:ab_mask}
...
\subsection*{Mathématiques Complémentaires}
\phantomsection\label{subsec:ab_further_mathematics}
...
\subsection*{Mathématiques supérieures}
\phantomsection\label{subsec:ab_higher_mathematics}

Vous êtes entraîné aux mathématiques standards et supérieures. Facilitateur. (Higher Mathematics \textendash (149))

\subsection*{Maximiser le Cypher}
\phantomsection\label{subsec:ab_maximize_cypher}
...
\subsection*{Maître artisan}
\phantomsection\label{subsec:ab_master_crafter}
...
\subsection*{Maître d'Arme}
\phantomsection\label{subsec:ab_weapon_master}

Vous infligez 1 point de dégâts supplémentaire avec l'arme de votre choix. Facilitateur. (Weapon Master \textendash (197))

\subsection*{Maître de la défense}
\phantomsection\label{subsec:ab_defense_master}
...
\subsection*{Maître du spectacle}
\phantomsection\label{subsec:ab_master_entertainer}
...
\subsection*{Maître du style de combat à mains nues}
\phantomsection\label{subsec:ab_master_of_unarmed_fighting_style}
...
\subsection*{Maître voleur}
\phantomsection\label{subsec:ab_master_thief}
...
\subsection*{Maîtrise dans l' Utilisation des Cyphers}
\phantomsection\label{subsec:ab_master_cypher_use}

Vous pouvez utiliser cinq cyphers à la fois. Facilitateur. (Master Cypher Use \textendash (160))

\subsection*{Maîtrise de l'Identification des appareils}
\phantomsection\label{subsec:ab_master_identifier}

Vous êtes entraîné à identifier la fonction de tout type d'appareil. Facilitateur. (Master Identifier \textendash (160))

\subsection*{Maîtrise de la défense}
\phantomsection\label{subsec:ab_mastery_with_defense}
...
\subsection*{Maîtrise des Cyphers}
\phantomsection\label{subsec:ab_cyphersmith}
...
\subsection*{Maîtrise des Machines}
\phantomsection\label{subsec:ab_master_machine}
...
\subsection*{Maîtrise des attaques}
\phantomsection\label{subsec:ab_mastery_with_attacks}
...
\subsection*{Maîtrise des liens d'objet}
\phantomsection\label{subsec:ab_object_bond_mastery}
...
\subsection*{Maîtrise des outils}
\phantomsection\label{subsec:ab_tool_mastery}
...
\subsection*{Maîtrise du Bouclier}
\phantomsection\label{subsec:ab_shield_master}
...
\subsection*{Maîtrise extrême}
\phantomsection\label{subsec:ab_extreme_mastery}
...
\subsection*{Mener depuis le front}
\phantomsection\label{subsec:ab_lead_from_the_front}
...
\subsection*{Mentalement résistant}
\phantomsection\label{subsec:ab_mentally_tough}
...
\subsection*{Mené par l'enquête}
\phantomsection\label{subsec:ab_lead_by_inquiry}
...
\subsection*{Mettre le paquet}
\phantomsection\label{subsec:ab_all_out_con}
...
\subsection*{Mettre un Ennemi en Phase}
\phantomsection\label{subsec:ab_phase_foe}
...
\subsection*{Meurtre Rapide}
\phantomsection\label{subsec:ab_fast_kill}
...
\subsection*{Meurtrier}
\phantomsection\label{subsec:ab_murderer}
...
\subsection*{Mieux vivre grâce à la chimie}
\phantomsection\label{subsec:ab_better_living_through_chemistry}
...
\subsection*{Minuscule}
\phantomsection\label{subsec:ab_tiny}
...
\subsection*{Mise à niveau du robot}
\phantomsection\label{subsec:ab_robot_upgrade}
...
\subsection*{Modification magistrale de l'armure}
\phantomsection\label{subsec:ab_masterful_armor_modification}
...
\subsection*{Modifier l'appareil}
\phantomsection\label{subsec:ab_modify_device}
...
\subsection*{Modifier la Puissance de l'Artefact}
\phantomsection\label{subsec:ab_modify_artifact_power}
...
\subsection*{Modifier les Cyphers}
\phantomsection\label{subsec:ab_modify_cyphers}
...
\phantomsection\label{subsec:ab_predictive_model}
...
\subsection*{Moment magnifique}
\phantomsection\label{subsec:ab_magnificent_moment}
...
\subsection*{Momentum}
\phantomsection\label{subsec:ab_momentum}
...
\subsection*{Montrez-leur le chemin}
\phantomsection\label{subsec:ab_show_them_the_way}
...
\subsection*{Monture}
\phantomsection\label{subsec:ab_mount}
...
\subsection*{Moqueries confondantes}
\phantomsection\label{subsec:ab_confounding_banter}
...
\subsection*{Mort rapide}
\phantomsection\label{subsec:ab_quick_death}
...
\subsection*{Mot de commandement}
\phantomsection\label{subsec:ab_word_of_command}
...
\subsection*{Mot de mort}
\phantomsection\label{subsec:ab_word_of_death}
...
\subsection*{Mouvement enchanté}
\phantomsection\label{subsec:ab_enchanted_movement}
...
\subsection*{Mouvements de culbute}
\phantomsection\label{subsec:ab_tumbling_moves}
...
\subsection*{Multiples Proies}
\phantomsection\label{subsec:ab_multiple_quarry}
...
\phantomsection\label{subsec:ab_multiplicity}
...
\subsection*{Mur avec des dents}
\phantomsection\label{subsec:ab_wall_with_teeth}
...
\subsection*{Mur de Force}
\phantomsection\label{subsec:ab_force_wall}
...
\subsection*{Mur de Granit}
\phantomsection\label{subsec:ab_granite_wall}
...
\subsection*{Mur de foudre}
\phantomsection\label{subsec:ab_wall_of_lightning}
...
\subsection*{Mur de protection}
\phantomsection\label{subsec:ab_protective_wall}
...
\subsection*{Mur vivant}
\phantomsection\label{subsec:ab_living_wall}
...
\subsection*{Muscles de fer}
\phantomsection\label{subsec:ab_muscles_of_iron}
...
\subsection*{Mécanicien de passage}
\phantomsection\label{subsec:ab_passing_mechanic}
...
\subsection*{Mécanismes de désactivation}
\phantomsection\label{subsec:ab_disable_mechanisms}
...
\subsection*{Mémoire de Pouvoir Copié}
\phantomsection\label{subsec:ab_power_memory}
...
\subsection*{Nager}
\phantomsection\label{subsec:ab_swim}
...
\subsection*{Nageur agile}
\phantomsection\label{subsec:ab_nimble_swimmer}

vous êtes entraîné à toutes les actions de défense sous l'eau. Facilitateur. (Nimble Swimmer \textendash (166))

\subsection*{Nageur entraîné sous l'eau}
\phantomsection\label{subsec:ab_trained_swimmer}
...
\subsection*{Ne jamais échouer}
\phantomsection\label{subsec:ab_never_fumble}
...
\subsection*{Noblesse privilégiée}
\phantomsection\label{subsec:ab_privileged_nobility}
...
\subsection*{Nuage de brume}
\phantomsection\label{subsec:ab_mist_cloud}
...
\subsection*{Nuage de matière}
\phantomsection\label{subsec:ab_matter_cloud}
...
\subsection*{Nécromancie}
\phantomsection\label{subsec:ab_necromancy}
...
\subsection*{Nécromancie Supérieure}
\phantomsection\label{subsec:ab_greater_necromancy}
...
\subsection*{Négocier}
\phantomsection\label{subsec:ab_negotiate}
...
\subsection*{Objectif du tireur d'élite}
\phantomsection\label{subsec:ab_sniper's_aim}
...
\subsection*{Oeil perçant}
\phantomsection\label{subsec:ab_sharp_eyed}
...
\subsection*{Oeil pour Cibler}
\phantomsection\label{subsec:ab_targeting_eye}
...
\subsection*{Oeil pour les détails}
\phantomsection\label{subsec:ab_eye_for_detail}
...
\subsection*{Opportuniste}
\phantomsection\label{subsec:ab_opportunist}
...
\subsection*{Orateur pour les morts}
\phantomsection\label{subsec:ab_speaker_for_the_dead}
...
\subsection*{Ordonner au Vaisseau}
\phantomsection\label{subsec:ab_shipspeak}
...
\subsection*{Parade}
\phantomsection\label{subsec:ab_parry}
...
\subsection*{Parfait Inconnu}
\phantomsection\label{subsec:ab_perfect_stranger}
...
\subsection*{Partager la défense}
\phantomsection\label{subsec:ab_share_defense}
...
\subsection*{Partager les sens}
\phantomsection\label{subsec:ab_share_senses}
...
\subsection*{Partagez le pouvoir}
\phantomsection\label{subsec:ab_share_the_power}
...
\subsection*{Pas besoin d'armes}
\phantomsection\label{subsec:ab_no_need_for_weapons}
...
\subsection*{Pas encore mort}
\phantomsection\label{subsec:ab_not_dead_yet}
...
\subsection*{Pas subtiles}
\phantomsection\label{subsec:ab_subtle_steps}
...
\subsection*{Passager psychique}
\phantomsection\label{subsec:ab_psychic_passenger}
...
\subsection*{Passer l'information au suivant}
\phantomsection\label{subsec:ab_pay_it_forward}
...
\subsection*{Passer à travers}
\phantomsection\label{subsec:ab_push_on_through}
...
\subsection*{Penser à l'avance}
\phantomsection\label{subsec:ab_thinking_ahead}
...
\subsection*{Pensez à votre sortie}
\phantomsection\label{subsec:ab_think_your_way_out}
...
\subsection*{Percer les Défenses}
\phantomsection\label{subsec:ab_pry_open}
...
\subsection*{Percée scientifique étrange}
\phantomsection\label{subsec:ab_weird_science_breakthrough}
...
\subsection*{Perdu dans le chaos}
\phantomsection\label{subsec:ab_lost_in_the_chaos}
...
\subsection*{Performance vindicative}
\phantomsection\label{subsec:ab_vindictive_performance}
...
\subsection*{Personne ne sait mieux}
\phantomsection\label{subsec:ab_no_one_knows_better}
...
\subsection*{Perspicacité}
\phantomsection\label{subsec:ab_insight}
...
\subsection*{Persuasion et Tromperie}
\phantomsection\label{subsec:ab_opening_statement}
...
\subsection*{Petit Compagnon}
\phantomsection\label{subsec:ab_critter_companion}
...
\subsection*{Petit vol}
\phantomsection\label{subsec:ab_small_flight}
...
\subsection*{Phase défensive}
\phantomsection\label{subsec:ab_defensive_phasing}
...
\subsection*{Physique amélioré}
\phantomsection\label{subsec:ab_enhanced_physique}
...
\subsection*{Physique amélioré supérieur}
\phantomsection\label{subsec:ab_greater_enhanced_physique}
...
\subsection*{Physiquement doué}
\phantomsection\label{subsec:ab_physically_gifted}
...
\subsection*{Pied Léger}
\phantomsection\label{subsec:ab_fleet_of_foot}
...
\subsection*{Pilleur Entraîné}
\phantomsection\label{subsec:ab_trained_excavator}

Vous êtes entraîné aux tâches de perception, d'escalade et de récupération. Facilitateur. (Trained Excavator \textendash (193))

\subsection*{Pilleur d'artifact}
\phantomsection\label{subsec:ab_artifact_scavenger}
...
\subsection*{Pilote}
\phantomsection\label{subsec:ab_pilot}
...
\subsection*{Pilote Expert}
\phantomsection\label{subsec:ab_expert_pilot}
...
\subsection*{Pilote Incomparable}
\phantomsection\label{subsec:ab_incomparable_pilot}
...
\subsection*{Piste Infernale}
\phantomsection\label{subsec:ab_inferno_trail}
...
\subsection*{Pisteur}
\phantomsection\label{subsec:ab_tracker}

Vous êtes entraîné au suivi et à l'identification des traces. Facilitateur. (Tracker \textendash (193))

\subsection*{Piétinement de Golem}
\phantomsection\label{subsec:ab_golem_stomp}
...
\subsection*{Placard caché}
\phantomsection\label{subsec:ab_hidden_closet}
...
\subsection*{Plan d'évasion}
\phantomsection\label{subsec:ab_escape_plan}
...
\subsection*{Planificateur méticuleux}
\phantomsection\label{subsec:ab_meticulous_planner}
...
\subsection*{Plongeur}
\phantomsection\label{subsec:ab_diver}
...
\subsection*{Plus forts ensemble}
\phantomsection\label{subsec:ab_stronger_together}
...
\subsection*{Plus grand}
\phantomsection\label{subsec:ab_bigger}
...
\subsection*{Plus petit}
\phantomsection\label{subsec:ab_smaller}
...
\subsection*{Plus rapide que la plupart}
\phantomsection\label{subsec:ab_quicker_than_most}
...
\subsection*{Poche de Phase}
\phantomsection\label{subsec:ab_phased_pocket}
...
\subsection*{Poids du monde}
\phantomsection\label{subsec:ab_weight_of_the_world}
...
\subsection*{Poignée élastique}
\phantomsection\label{subsec:ab_elastic_grip}
...
\subsection*{Porter un jugement}
\phantomsection\label{subsec:ab_make_judgment}
...
\subsection*{Portez-la bien}
\phantomsection\label{subsec:ab_wear_it_well}
...
\subsection*{Poser des Pièges}
\phantomsection\label{subsec:ab_trapster}
...
\subsection*{Position fortifiée}
\phantomsection\label{subsec:ab_fortified_position}
...
\subsection*{Potentiel amélioré}
\phantomsection\label{subsec:ab_enhanced_potential}
...
\subsection*{Potentiel amélioré plus important}
\phantomsection\label{subsec:ab_greater_enhanced_potential}
...
\subsection*{Poussière Retourne à la Poussière}
\phantomsection\label{subsec:ab_dust_to_dust}
...
\subsection*{Poussée}
\phantomsection\label{subsec:ab_push}
...
\subsection*{Pouvoir de copie}
\phantomsection\label{subsec:ab_copy_power}
...
\subsection*{Pouvoir inné}
\phantomsection\label{subsec:ab_innate_power}
...
\subsection*{Pouvoirs génériques}
\phantomsection\label{subsec:ab_wildcard_powers}
...
\subsection*{Pratique de toutes les armes}
\phantomsection\label{subsec:ab_practiced_with_all_weapons}
...
\subsection*{Pratique des armes moyennes}
\phantomsection\label{subsec:ab_practiced_with_medium_weapons}
...
\subsection*{Pratique des armes à feu}
\phantomsection\label{subsec:ab_practiced_with_guns}
...
\subsection*{Pratique des armures}
\phantomsection\label{subsec:ab_practiced_in_armor}
...
\subsection*{Prendre l'initiative}
\phantomsection\label{subsec:ab_seize_the_initiative}
...
\subsection*{Prendre le commandement}
\phantomsection\label{subsec:ab_take_command}
...
\phantomsection\label{subsec:ab_legerdemain}
...
\subsection*{Prise de Golem}
\phantomsection\label{subsec:ab_golem_grip}
...
\subsection*{Processeur d'action}
\phantomsection\label{subsec:ab_action_processor}
...
\subsection*{Programmation informatique}
\phantomsection\label{subsec:ab_computer_programming}
...
\subsection*{Proie}
\phantomsection\label{subsec:ab_quarry}
...
\phantomsection\label{subsec:ab_projection}
...
\subsection*{Projection Psychique}
\phantomsection\label{subsec:ab_psychic_burst}
...
\subsection*{Projection mentale}
\phantomsection\label{subsec:ab_mental_projection}
...
\subsection*{Protecteur}
\phantomsection\label{subsec:ab_protector}
...
\phantomsection\label{subsec:ab_ward}
...
\subsection*{Protection élémentaire}
\phantomsection\label{subsec:ab_elemental_protection}
...
\subsection*{Protection énergétique}
\phantomsection\label{subsec:ab_energy_protection}
...
\subsection*{Prouesses au combat}
\phantomsection\label{subsec:ab_combat_prowess}
...
\subsection*{Provoquer l'ennemi}
\phantomsection\label{subsec:ab_taunt_foe}
...
\phantomsection\label{subsec:ab_precision}
...
\subsection*{Précognition}
\phantomsection\label{subsec:ab_precognition}
...
\subsection*{Prémonition}
\phantomsection\label{subsec:ab_premonition}
...
\subsection*{Présence encourageante}
\phantomsection\label{subsec:ab_encouraging_presence}
...
\subsection*{Présence reposante}
\phantomsection\label{subsec:ab_restful_presence}
...
\subsection*{Présence terrifiante}
\phantomsection\label{subsec:ab_terrifying_presence}
...
\subsection*{Prêter une forme animale}
\phantomsection\label{subsec:ab_lend_animal_shape}
...
\subsection*{Psychose}
\phantomsection\label{subsec:ab_psychosis}
...
\subsection*{Puissance Améliorée}
\phantomsection\label{subsec:ab_enhanced_might}

vous gagnez 3 points dans votre réserve de Puissance. Facilitateur. (Enhanced Might \textendash (135))

\subsection*{Puissance améliorée supérieure}
\phantomsection\label{subsec:ab_greater_enhanced_might}

vous gagnez 6 points dans votre réserve de Puissance. Facilitateur. (Greater Enhanced Might \textendash (146))

\subsection*{Puissance d'attraction}
\phantomsection\label{subsec:ab_coaxing_power}
...
\subsection*{Pulsation de Guérison}
\phantomsection\label{subsec:ab_healing_pulse}
...
\phantomsection\label{subsec:ab_spray}
...
\subsection*{Punir le coupable}
\phantomsection\label{subsec:ab_punish_the_guilty}
...
\subsection*{Punir tous les coupables}
\phantomsection\label{subsec:ab_punish_all_the_guilty}
...
\subsection*{Quelque chose sur la route}
\phantomsection\label{subsec:ab_something_in_the_road}
...
\subsection*{Radiance divine}
\phantomsection\label{subsec:ab_divine_radiance}
...
\subsection*{Ralliez-vous à moi}
\phantomsection\label{subsec:ab_rally_to_me}
...
\subsection*{Ramener}
\phantomsection\label{subsec:ab_apportation}
...
\subsection*{Ramener amélioré}
\phantomsection\label{subsec:ab_improved_apportation}
...
\subsection*{Rapide Tromperie}
\phantomsection\label{subsec:ab_pull_a_fast_one}
...
\subsection*{Rapide à fuir}
\phantomsection\label{subsec:ab_quick_to_flee}

vous êtes entraîné aux tâches de furtivité et de mouvement. Facilitateur. (Quick to Flee \textendash (174))

\subsection*{Rat des Allées}
\phantomsection\label{subsec:ab_alley_rat}
...
\subsection*{Rayer l'Existence}
\phantomsection\label{subsec:ab_scratch_existence}
...
\subsection*{Rayon de confusion}
\phantomsection\label{subsec:ab_ray_of_confusion}
...
\phantomsection\label{subsec:ab_reload}
...
\subsection*{Recruter un adjoint}
\phantomsection\label{subsec:ab_recruit_deputy}
...
\subsection*{Recueillir des renseignements}
\phantomsection\label{subsec:ab_gather_intelligence}
...
\subsection*{Regard terrifiant}
\phantomsection\label{subsec:ab_terrifying_gaze}
...
\subsection*{Regarde les en Face}
\phantomsection\label{subsec:ab_stare_them_down}
...
\subsection*{Relocaliser}
\phantomsection\label{subsec:ab_relocate}
...
\subsection*{Remodeler}
\phantomsection\label{subsec:ab_reshape}
...
\subsection*{Renforcer l'illusion}
\phantomsection\label{subsec:ab_bolster_illusion}
...
\subsection*{Repousser le métal}
\phantomsection\label{subsec:ab_repel_metal}
...
\subsection*{Repérer la faiblesse}
\phantomsection\label{subsec:ab_spot_weakness}
...
\subsection*{Ressources profondes}
\phantomsection\label{subsec:ab_deep_resources}

vous gagnez 6 points supplémentaires à votre réserve de Célérité. Facilitateur. (Deep Resources \textendash (126))

\subsection*{Restaurer la vie}
\phantomsection\label{subsec:ab_restore_life}
...
\subsection*{Rester en Alerte}
\phantomsection\label{subsec:ab_stand_watch}
...
\phantomsection\label{subsec:ab_hold_breath}
...
\phantomsection\label{subsec:ab_return_to_the_obelisk}
...
\subsection*{Retour à l'expéditeur}
\phantomsection\label{subsec:ab_return_to_sender}
...
\subsection*{Rhétorique puissante}
\phantomsection\label{subsec:ab_powerful_rhetoric}
...
\subsection*{Rien que Défendre}
\phantomsection\label{subsec:ab_nothing_but_defend}
...
\subsection*{Réaction}
\phantomsection\label{subsec:ab_reaction}
...
\subsection*{Réanimer}
\phantomsection\label{subsec:ab_resuscitate}
...
\subsection*{Récupération Rapide d'un autre}
\phantomsection\label{subsec:ab_speedy_recovery}
...
\subsection*{Récupération améliorée}
\phantomsection\label{subsec:ab_improved_recovery}
...
\subsection*{Récupération du patient}
\phantomsection\label{subsec:ab_patient_recovery}

vous gagnez un jet de récupération supplémentaire de dix minutes chaque jour. Facilitateur. (Patient Recovery \textendash (168))

\subsection*{Récupération et confort}
\phantomsection\label{subsec:ab_salvage_and_comfort}
...
\subsection*{Récupération rapide}
...
\subsection*{Récupération supplémentaire}
\phantomsection\label{subsec:ab_extra_recovery}

vous gagnez une récupération suplémentaire en une seule action chaque jour. Facilitateur. (Extra Recovery \textendash (138))

\subsection*{Récupérer}
\phantomsection\label{subsec:ab_fetch}
...
\subsection*{Récupérer des souvenirs}
\phantomsection\label{subsec:ab_retrieve_memories}
...
\phantomsection\label{subsec:ab_rejeneration}
...
\subsection*{Régénérer}
\phantomsection\label{subsec:ab_regenerate}
...
\subsection*{Régénérer un autre}
\phantomsection\label{subsec:ab_regenerate_other}
...
\subsection*{Réparer la chair}
\phantomsection\label{subsec:ab_repair_flesh}
...
\subsection*{Répertoire magique}
\phantomsection\label{subsec:ab_magical_repertoire}
...
\subsection*{Répertoire étendu}
\phantomsection\label{subsec:ab_expanded_repertoire}
...
\subsection*{Réputation de hors-la-loi}
\phantomsection\label{subsec:ab_outlaw_reputation}
...
\subsection*{Réputation redoutable}
\phantomsection\label{subsec:ab_fearsome_reputation}
...
\subsection*{Réseau de capteurs}
\phantomsection\label{subsec:ab_sensor_array}
...
\subsection*{Réseau télépathique}
\phantomsection\label{subsec:ab_telepathic_network}
...
\subsection*{Réserves Partagées}
\phantomsection\label{subsec:ab_deep_reserves}
...
\subsection*{Réserves cachées}
\phantomsection\label{subsec:ab_hidden_reserves}
...
\phantomsection\label{subsec:ab_resilience}
...
\subsection*{Résilience durement gagnée}
\phantomsection\label{subsec:ab_hard_won_resilience}
...
\subsection*{Résistance au poison}
\phantomsection\label{subsec:ab_poison_resistance}
...
\subsection*{Résistance énergétique}
\phantomsection\label{subsec:ab_energy_resistance}
...
\subsection*{Résister aux dangers sous-marins}
\phantomsection\label{subsec:ab_resist_underwater_hazards}
...
\subsection*{Résistez aux éléments}
\phantomsection\label{subsec:ab_resist_the_elements}
...
\subsection*{Résoudre des Enigmes}
\phantomsection\label{subsec:ab_resist_tricks}
...
\subsection*{Rétrécir}
\phantomsection\label{subsec:ab_shrink}
...
\subsection*{Rétrécir les autres}
\phantomsection\label{subsec:ab_shrink_others}
...
\subsection*{Révèle}
\phantomsection\label{subsec:ab_reveal}
...
\subsection*{Rêverie}
\phantomsection\label{subsec:ab_daydream}
...
\subsection*{S'appuyer sur les expériences de la vie}
\phantomsection\label{subsec:ab_drawing_on_life's_experiences}
...
\subsection*{Sachez où chercher}
\phantomsection\label{subsec:ab_know_where_to_look}
...
\subsection*{Sacrifice volontaire}
\phantomsection\label{subsec:ab_willing_sacrifice}
...
\subsection*{Saisir}
\phantomsection\label{subsec:ab_grab}
...
\subsection*{Saisissez l'instant}
\phantomsection\label{subsec:ab_seize_the_moment}
...
\subsection*{Sans âge}
\phantomsection\label{subsec:ab_ageless}
...
\subsection*{Sans être remarqué}
\phantomsection\label{subsec:ab_beneath_notice}
...
\subsection*{Santé incroyable}
\phantomsection\label{subsec:ab_incredible_health}
...
\subsection*{Santé miraculeuse}
\phantomsection\label{subsec:ab_miraculous_health}
...
\subsection*{Saut de Côté}
\phantomsection\label{subsec:ab_spring_away}
...
\subsection*{Saut incroyable}
\phantomsection\label{subsec:ab_amazing_leap}
...
\subsection*{Sauter en Microgravité}
\phantomsection\label{subsec:ab_push_off_and_throw}
...
\subsection*{Sauts de Téléportation}
\phantomsection\label{subsec:ab_teleportation_burst}
...
\subsection*{Scan}
\phantomsection\label{subsec:ab_scan}
...
\subsection*{Science du Sommeil}
\phantomsection\label{subsec:ab_oneirochemy}
...
\subsection*{Sculpter la chair}
\phantomsection\label{subsec:ab_sculpt_flesh}
...
\subsection*{Sculpter la lumière}
\phantomsection\label{subsec:ab_sculpt_light}
...
\subsection*{Se Fendre}
\phantomsection\label{subsec:ab_lunge}
...
\subsection*{Se Glisser dans l'ombre}
\phantomsection\label{subsec:ab_slip_into_shadow}
...
\subsection*{Se déplacer comme l'eau}
\phantomsection\label{subsec:ab_moving_like_water}
...
\subsection*{Se fondre dans le décor}
\phantomsection\label{subsec:ab_blend_in}
...
\subsection*{Sens aiguisés}
\phantomsection\label{subsec:ab_sharp_senses}

Vous êtes entraîné à toutes les tâches impliquant la perception. Facilitateur. (Sharp Senses \textendash (182))

\subsection*{Sens du Danger}
\phantomsection\label{subsec:ab_danger_sense}
...
\subsection*{Sens et sensibilités animales}
\phantomsection\label{subsec:ab_animal_senses_and_sensibilities}
...
\subsection*{Sens surnaturels}
\phantomsection\label{subsec:ab_preternatural_senses}
...
\subsection*{Sensibilisation à la nature sauvage}
\phantomsection\label{subsec:ab_wilderness_awareness}
...
\subsection*{Sentir les Attitudes}
\phantomsection\label{subsec:ab_sense_attitudes}
...
\subsection*{Sentir une Embuscade}
\phantomsection\label{subsec:ab_sense_ambush}

Vous n'êtes jamais surpris par une attaque. Facilitateur. (Sense Ambush \textendash (181))

\subsection*{Serv-0}
\phantomsection\label{subsec:ab_serv_0}
...
\subsection*{Serv-0 Bagarreur}
\phantomsection\label{subsec:ab_serv_0_brawler}
...
\subsection*{Serv-0 Defenseur}
\phantomsection\label{subsec:ab_serv_0_defender}
...
\subsection*{Serv-0 Espion}
\phantomsection\label{subsec:ab_serv_0_spy}
...
\subsection*{Serv-0 Réparateur}
\phantomsection\label{subsec:ab_serv_0_repair}
...
\subsection*{Serv-0 Scanner}
\phantomsection\label{subsec:ab_serv_0_scanner}

Votre Serv-0 acquiert la capacité Scan. Facilitateur. (Serv-0 Scanner \textendash (181))

\subsection*{Serv-0 Viseur}
\phantomsection\label{subsec:ab_serv_0_aim}
...
\subsection*{Serviteur du Feu}
\phantomsection\label{subsec:ab_fire_servant}
...
\subsection*{Silencieux comme l'espace}
\phantomsection\label{subsec:ab_silent_as_space}
...
\subsection*{Simple et Direct}
\phantomsection\label{subsec:ab_straightforward}
...
\subsection*{Siphon solaire}
\phantomsection\label{subsec:ab_sun_siphon}
...
\subsection*{Soif de sang}
\phantomsection\label{subsec:ab_bloodlust}
...
\subsection*{Souhait mineur}
\phantomsection\label{subsec:ab_minor_wish}
...
\subsection*{Souhait modéré}
\phantomsection\label{subsec:ab_moderate_wish}
...
\subsection*{Soulager}
\phantomsection\label{subsec:ab_alleviate}
...
\subsection*{Source de guérison}
\phantomsection\label{subsec:ab_font_of_healing}
...
\subsection*{Sprint de Phase}
\phantomsection\label{subsec:ab_phase_sprint}
...
\subsection*{Spécialisation de tâche}
\phantomsection\label{subsec:ab_task_specialization}
...
\subsection*{Stagiaire juridique}
\phantomsection\label{subsec:ab_legal_intern}
...
\subsection*{Stase}
\phantomsection\label{subsec:ab_stasis}
...
\subsection*{Stimuler}
\phantomsection\label{subsec:ab_stimulate}
...
\subsection*{Stimuler l'effort}
\phantomsection\label{subsec:ab_spur_effort}
...
\subsection*{Stocker l'énergie}
\phantomsection\label{subsec:ab_store_energy}
...
\subsection*{Stratagème mortel}
\phantomsection\label{subsec:ab_lethal_ploy}
...
\subsection*{Structure de matière noire}
\phantomsection\label{subsec:ab_dark_matter_structure}
...
\subsection*{Style de combat à mains nues}
\phantomsection\label{subsec:ab_unarmed_fighting_style}

Vous êtes entraîné aux attaques à mains nues. Facilitateur. (Unarmed Fighting Style \textendash (194))

\subsection*{Succès amélioré}
\phantomsection\label{subsec:ab_improved_success}
...
\subsection*{Succès inspirant}
\phantomsection\label{subsec:ab_inspiring_success}
...
\phantomsection\label{subsec:ab_suggestion}
...
\subsection*{Suggestion Psychique}
\phantomsection\label{subsec:ab_psychic_suggestion}
...
\subsection*{Suite de Servants}
\phantomsection\label{subsec:ab_retinue}
...
\subsection*{Suivant de base}
\phantomsection\label{subsec:ab_basic_follower}
...
\subsection*{Surcharge d'Appareil}
\phantomsection\label{subsec:ab_overcharge_device}
...
\subsection*{Surcharge d'énergie}
...
\subsection*{Surcharge de Machine}
\phantomsection\label{subsec:ab_overload_machine}
...
\subsection*{Surfeur de Matière Noire}
\phantomsection\label{subsec:ab_windwracked_traveler}
...
\subsection*{Surfeur de voiture}
\phantomsection\label{subsec:ab_car_surfer}
...
\subsection*{Surfeur des Vents}
\phantomsection\label{subsec:ab_windrider}
...
\subsection*{Surmontez tous les obstacles}
\phantomsection\label{subsec:ab_overcome_all_obstacles}
...
\subsection*{Sursaut de Cypher}
\phantomsection\label{subsec:ab_cypher_surge}
...
\subsection*{Sursaut de Célérité}
\phantomsection\label{subsec:ab_speed_burst}
...
\subsection*{Sursaut de Célérité Parfait}
\phantomsection\label{subsec:ab_perfect_speed_burst}

vous pouvez effectuer deux actions distinctes ce tour-ci. Facilitateur. (Perfect Speed Burst \textendash (169))

\subsection*{Sursaut de confiance}
\phantomsection\label{subsec:ab_surging_confidence}
...
\subsection*{Sursaut mental}
\phantomsection\label{subsec:ab_mind_surge}
...
\subsection*{Survivant post-apocalyptique}
\phantomsection\label{subsec:ab_post_apocalyptic_survivor}
...
\subsection*{Survivre à l'ennemi}
\phantomsection\label{subsec:ab_outlast_the_foe}
...
\subsection*{Survol}
\phantomsection\label{subsec:ab_hover}
...
\subsection*{Symbole divin}
\phantomsection\label{subsec:ab_divine_symbol}
...
\subsection*{Tacticien du champ de bataille}
\phantomsection\label{subsec:ab_battlefield_tactician}
...
\subsection*{Tactiques de la Horde}
\phantomsection\label{subsec:ab_horde_tactics}
...
\subsection*{Talent Oratoire}
\phantomsection\label{subsec:ab_oratory}
...
\subsection*{Talent de célébrité}
\phantomsection\label{subsec:ab_celebrity_talent}
...
\subsection*{Tempête de Glace}
\phantomsection\label{subsec:ab_ice_storm}
...
\subsection*{Tenez bon}
\phantomsection\label{subsec:ab_tough_it_out}
...
\subsection*{Tir Arcanique}
\phantomsection\label{subsec:ab_arcane_flare}
...
\subsection*{Tir Double}
\phantomsection\label{subsec:ab_trick_shot}
...
\subsection*{Tir Guidé}
\phantomsection\label{subsec:ab_guide_bolt}
...
\subsection*{Tir Perforant}
\phantomsection\label{subsec:ab_pierce}
...
\subsection*{Tir Précis}
\phantomsection\label{subsec:ab_snipe}
...
\subsection*{Tir Rapide}
\phantomsection\label{subsec:ab_snap_shot}
...
\subsection*{Tir d'Opportunité}
\phantomsection\label{subsec:ab_overwatch}
...
\subsection*{Tir en apesanteur}
\phantomsection\label{subsec:ab_weightless_shot}
...
\subsection*{Tir prudent}
\phantomsection\label{subsec:ab_careful_shot}
...
\subsection*{Tirer une conclusion}
\phantomsection\label{subsec:ab_draw_conclusion}
...
\subsection*{Tireur}
\phantomsection\label{subsec:ab_gunner}

Vous infligez 1 point de dégâts supplémentaire avec les armes à feu. Facilitateur. (Gunner \textendash (147))

\subsection*{Tireur entraîné}
\phantomsection\label{subsec:ab_trained_gunner}
...
\subsection*{Tirs en éventail}
\phantomsection\label{subsec:ab_arc_spray}
...
\subsection*{Torsion du couteau}
\phantomsection\label{subsec:ab_twisting_the_knife}
...
\subsection*{Totalement Chill}
\phantomsection\label{subsec:ab_totally_chill}

Votre jet de récupération de dix minutes ne vous prend qu'un seul round. Facilitateur. (Totally Chill \textendash (192))

\subsection*{Toucher Glacial}
\phantomsection\label{subsec:ab_frost_touch}
...
\subsection*{Toucher Mortel}
\phantomsection\label{subsec:ab_death_touch}
...
\subsection*{Toucher de Froid Paralysant}
\phantomsection\label{subsec:ab_freezing_touch}
...
\subsection*{Toucher lumineux}
\phantomsection\label{subsec:ab_illuminating_touch}
...
\subsection*{Toucher perturbateur}
\phantomsection\label{subsec:ab_disrupting_touch}
...
\subsection*{Toujours bricoler}
\phantomsection\label{subsec:ab_always_tinkering}
...
\subsection*{Toujours comme une statue}
\phantomsection\label{subsec:ab_still_as_a_statue}
...
\subsection*{Tour de Volonté}
\phantomsection\label{subsec:ab_tower_of_will}
...
\subsection*{Tour de force}
\phantomsection\label{subsec:ab_feat_of_strength}
...
\subsection*{Tour de l'Intellect}
\phantomsection\label{subsec:ab_tower_of_intellect}
...
\subsection*{Tourbillon de lancers}
\phantomsection\label{subsec:ab_whirlwind_of_throws}
...
\subsection*{Tout est une arme}
\phantomsection\label{subsec:ab_everything_is_a_weapon}
...
\subsection*{Trahison}
\phantomsection\label{subsec:ab_betrayal}
...
\subsection*{Trahison inattendue}
\phantomsection\label{subsec:ab_unexpected_betrayal}
...
\subsection*{Traitement rapide}
\phantomsection\label{subsec:ab_rapid_processing}
...
\subsection*{Transcendez le scénario}
\phantomsection\label{subsec:ab_transcend_the_script}
...
\subsection*{Transfert de dégâts}
\phantomsection\label{subsec:ab_damage_transference}
...
\subsection*{Transmettre la compréhension}
\phantomsection\label{subsec:ab_impart_understanding}
...
\subsection*{Transmettre un idéal}
\phantomsection\label{subsec:ab_impart_ideal}
...
\subsection*{Traqueur}
\phantomsection\label{subsec:ab_stalker}
...
\phantomsection\label{subsec:ab_teamwork}
...
\subsection*{Travail rapide}
\phantomsection\label{subsec:ab_quick_work}
...
\subsection*{Travaux Manuels}
\phantomsection\label{subsec:ab_handy}
...
\subsection*{Traverser les murs}
\phantomsection\label{subsec:ab_walk_through_walls}
...
\subsection*{Traversez les mondes}
\phantomsection\label{subsec:ab_traverse_the_worlds}
...
\subsection*{Tremblement de résonance}
\phantomsection\label{subsec:ab_resonant_quake}
...
\subsection*{Tremblement de terre}
\phantomsection\label{subsec:ab_earthquake}
...
\subsection*{Troisième œil}
\phantomsection\label{subsec:ab_third_eye}
...
\subsection*{Troisième œil itinérant}
\phantomsection\label{subsec:ab_roaming_third_eye}
...
\subsection*{Trou de ver}
\phantomsection\label{subsec:ab_wormhole}
...
\subsection*{Trouver ce qui est caché}
\phantomsection\label{subsec:ab_find_the_hidden}
...
\subsection*{Trouver le chemin}
\phantomsection\label{subsec:ab_find_the_way}
...
\subsection*{Trouver le coupable}
\phantomsection\label{subsec:ab_find_the_guilty}
...
\subsection*{Trouver les Pièges}
\phantomsection\label{subsec:ab_trapfinder}
...
\subsection*{Trouver une ouverture}
\phantomsection\label{subsec:ab_find_an_opening}
...
\subsection*{Très long sprint}
\phantomsection\label{subsec:ab_very_long_sprinting}
...
\phantomsection\label{subsec:ab_remote_control}
...
\phantomsection\label{subsec:ab_telekinesis}
...
\subsection*{Télépathie machine}
\phantomsection\label{subsec:ab_machine_telepathy}
...
\subsection*{Télépathie mécanique}
\phantomsection\label{subsec:ab_mechanical_telepathy}

En touchant une machine pensante, vous accédez à ses « pensées » superficielles. Action. (Mechanical Telepathy \textendash (161))

\subsection*{Télépathique}
\phantomsection\label{subsec:ab_telepathic}
...
\phantomsection\label{subsec:ab_teleportation}
...
\subsection*{Téléportation courte}
\phantomsection\label{subsec:ab_short_teleportation}
...
\subsection*{Téléportation en Ligne de Vue}
\phantomsection\label{subsec:ab_jaunt}
...
\subsection*{Téléportation moyenne}
\phantomsection\label{subsec:ab_medium_teleportation}
...
\subsection*{Ultra amélioration}
\phantomsection\label{subsec:ab_ultra_enhancement}

vous gagnez +1 à l'armure et +5 à chacun de vos trois pools de statistiques. Facilitateur. (Ultra Enhancement \textendash (194))

\subsection*{Un coup du Destin}
\phantomsection\label{subsec:ab_twist_of_fate}
...
\subsection*{Un sourire et un mot}
\phantomsection\label{subsec:ab_a_smile_and_a_word}
...
\subsection*{Une Bête comme Compagnon}
\phantomsection\label{subsec:ab_beast_companion}
...
\subsection*{Une information dans le réseau}
\phantomsection\label{subsec:ab_network_tap}
...
\subsection*{Usurpation de Cypher}
\phantomsection\label{subsec:ab_usurp_cypher}
...
\subsection*{Usurper l'identité}
\phantomsection\label{subsec:ab_impersonate}
...
\subsection*{Utilisation adroite des cyphers}
\phantomsection\label{subsec:ab_adroit_cypher_use}

Vous pouvez utiliser quatre cyphers à la fois. Facilitateur. (Adroit Cypher Use \textendash (108))

\subsection*{Utilisation de l'environnement}
\phantomsection\label{subsec:ab_using_the_environment}
...
\subsection*{Utilisation experte des cyphers}
\phantomsection\label{subsec:ab_expert_cypher_use}

Vous pouvez utiliser trois chiffres à la fois. Facilitateur. (Expert Cypher Use \textendash (137))

\subsection*{Utilisation supplémentaire}
\phantomsection\label{subsec:ab_extra_use}
...
\subsection*{Utiliser ce qui est disponible}
\phantomsection\label{subsec:ab_using_what's_available}
...
\subsection*{Utiliser les sens des autres}
\phantomsection\label{subsec:ab_use_senses_of_others}
...
\subsection*{Vantardise flamboyante}
\phantomsection\label{subsec:ab_flamboyant_boast}
...
\subsection*{Variante de Forme animale}
\phantomsection\label{subsec:ab_animal_shape_variant}
...
\subsection*{Verrouiller une Serrure}
\phantomsection\label{subsec:ab_lock}
...
\subsection*{Vibration mortelle}
\phantomsection\label{subsec:ab_lethal_vibration}
...
\subsection*{Vie en pleine nature}
\phantomsection\label{subsec:ab_wilderness_life}
...
\subsection*{Vif d'esprit}
\phantomsection\label{subsec:ab_quick_wits}
...
\phantomsection\label{subsec:ab_vigilance}
...
\subsection*{Vigilant}
\phantomsection\label{subsec:ab_vigilant}
...
\subsection*{Visualisation à distance}
\phantomsection\label{subsec:ab_remote_viewing}
...
\subsection*{Visée mortelle}
\phantomsection\label{subsec:ab_deadly_aim}
...
\subsection*{Visée prudente}
\phantomsection\label{subsec:ab_careful_aim}

Vous êtes entraîné aux attaques avec toutes les armes que vous lancez. Facilitateur. (Careful Aim \textendash (118))

\subsection*{Vitalité sauvage}
\phantomsection\label{subsec:ab_wild_vitality}
...
\subsection*{Vitesse de course incroyable}
\phantomsection\label{subsec:ab_incredible_running_speed}
...
\subsection*{Vitesse floue}
\phantomsection\label{subsec:ab_blurring_speed}
...
\subsection*{Vivre de la terre}
\phantomsection\label{subsec:ab_living_off_the_land}
...
\subsection*{Voilà votre problème}
\phantomsection\label{subsec:ab_there's_your_problem}
...
\subsection*{Voir Historique}
\phantomsection\label{subsec:ab_see_history}
...
\subsection*{Voir dans le Noir}
\phantomsection\label{subsec:ab_zero_dark_eyes}
...
\subsection*{Voir l'avenir}
\phantomsection\label{subsec:ab_see_the_future}
...
\subsection*{Voir l'invisible}
\phantomsection\label{subsec:ab_see_the_unseen}
...
\subsection*{Voir à travers la matière}
\phantomsection\label{subsec:ab_see_through_matter}
...
\subsection*{Voir à travers le temps}
\phantomsection\label{subsec:ab_see_through_time}
...
\subsection*{Vol}
\phantomsection\label{subsec:ab_flight}
...
\subsection*{Vol Court}
\phantomsection\label{subsec:ab_flight_exertion}
...
\subsection*{Vol électrique}
\phantomsection\label{subsec:ab_electrical_flight}
...
\subsection*{Voler le pouvoir}
\phantomsection\label{subsec:ab_steal_power}
...
\subsection*{Voleur de rêves}
\phantomsection\label{subsec:ab_dream_thief}
...
\subsection*{Volonté d'un leader}
\phantomsection\label{subsec:ab_will_of_a_leader}
...
\subsection*{Volonté de Légende}
\phantomsection\label{subsec:ab_will_of_legend}
...
\subsection*{Volonté du Chasseur}
\phantomsection\label{subsec:ab_hunters_drive}
...
\subsection*{Vous avez une Intuition}
\phantomsection\label{subsec:ab_got_a_feeling}
...
\subsection*{Vous avez étudié}
\phantomsection\label{subsec:ab_you_studied}
...
\subsection*{Voyage dans le temps}
\phantomsection\label{subsec:ab_time_travel}
...
\subsection*{Voyage dans les arbres}
\phantomsection\label{subsec:ab_tree_travel}
...
\subsection*{Voyage rapide}
\phantomsection\label{subsec:ab_fast_travel}
...
\subsection*{Vrilles de feu}
\phantomsection\label{subsec:ab_fire_tendrils}
...
\subsection*{Vulnérabilités des machines}
\phantomsection\label{subsec:ab_machine_vulnerabilities}
...
\subsection*{Véritable Gardien}
\phantomsection\label{subsec:ab_true_guardian}
...
\subsection*{Véritable Nécromancie}
\phantomsection\label{subsec:ab_true_necromancy}
...
\subsection*{Véritable défenseur}
\phantomsection\label{subsec:ab_true_defender}
...
\subsection*{Véritables sens}
\phantomsection\label{subsec:ab_true_senses}
...
\subsection*{Yeux ajustés}
\phantomsection\label{subsec:ab_eyes_adjusted}
...
\subsection*{Yeux de bête}
\phantomsection\label{subsec:ab_beast_eyes}
